...
It provides a core Business Rules Engine (BRE), a web authoring and rules management application (Drools Workbench), and full runtime support for Decision Model and Notation (DMN) models at Conformance level 3.
