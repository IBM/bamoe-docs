...
Do not let that scare you though, that simply means that there is a structure involved in how source code contributions are accepted.
...
There is no way to track work in community.
