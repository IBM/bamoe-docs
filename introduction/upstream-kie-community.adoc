...
A contributor, conversely, over time may become a component lead and eventually an architect based on merit and time with the project.
...
Since moving to IBM, the project work is tracked at https://github.com/orgs/apache/projects/295/views/1[IBM's GitHub board].

This board is for community work only, product specifics may not show up on the board.
