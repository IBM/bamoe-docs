...
* Quarkus LTS upgrade - {PRODUCT_SHORT} version {VERSION_91x} now supports the latest Long-Term Support (LTS) version of Quarkus 3.8.4, enhancing performance and reliability. 
