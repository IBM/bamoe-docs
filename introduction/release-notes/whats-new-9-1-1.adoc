...
* Java upgrade - Version {VERSION_91x} incorporates an upgraded technology stack featuring Java 17 and Jakarta EE 10.

* Quarkus LTS upgrade - Version {VERSION_91x}  supports the latest Long-Term Support (LTS) version of Quarkus 3.8.x by enhancing performance and reliability, and Quarkus 3.8.6 is tested and supported for version Version {VERSION_911}.
