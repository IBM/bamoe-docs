...
From the version {VERSION_911}, the Standalone Editors are now available enabling you to embed the BPMN and DMN editors in your application, and packages. Following are the packages that can be downloaded from passport advantage. 

* @ibm/bamoe-standalone-bpmn-and-dmn-editors-classic 
* @ibm/bamoe-standalone-dmn-editor

You can also check the <<Download document>> for package names.
