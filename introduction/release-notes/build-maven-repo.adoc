= Build and run your own BAMOE v9.1.0 Maven Repository image on OpenShift
include::../../partials/attributes.adoc[]

If you cannot run the container with elevated privileges, follow these instructions to build your own version that does not require the elevated privileges.
