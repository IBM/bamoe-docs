...
|Due to the Github API change, the raw URL does not work. Use the URL, '/:org/:repo/:tree/:path*' to import files from Github, see https://www.ibm.com/mysupport/aCIKe000000XfJo[issue,window=_blank]
