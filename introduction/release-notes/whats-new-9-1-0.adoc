...
* Helm Chart - A new Helm Chart is available and can be used to deploy {CANVAS} image on a Kubernetes cluster using the Helm package manager. This Helm chart, facilitates the management (define, install, and upgrade) of complex Kubernetes applications. xref:kie-helm-charts.html[Learn more...]
