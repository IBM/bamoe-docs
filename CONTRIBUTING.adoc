...
=== Screenhots
Documentation may often refer to screenhots, or to be more precie parts of screenhots.
For highlighting parts of the ascreenshots we could unify the used color as: `HEX: #008CB4` or `rgb: rgba(0,140,180,255)`