...
You can use a OpenShit or a Kubernetes distribution, for the purpose of this document we’ll use the OpenShift Sandbox (a free environment offered by Red Hat to try OpenShit - all you need is setup a few accounts), in production you may want your own internal OCP or Kubenertes”

image::bamoe-canvas-connected-accounts.png[Connect Accounts]
