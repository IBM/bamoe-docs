...
. Your new deployment will appear in the "Dev deployments" (1) drop-down. It will take about 30 seconds to be ready, and a green check will appear. Click on your deployment (2).
+
