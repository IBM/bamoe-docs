= Deploying a DMN model as a Decision microservice
...
[NOTE]
====
If you are not connected to Extended Services, a modal will open showing how to setup it in your local environment.
====
+
...
[NOTE]
====
If you are not connected to Extended Services, an additional modal will open showing how to setup it in your local environment. Click on "Setup" (*1*) and follow the instructions to continue with the Kubernetes login.
