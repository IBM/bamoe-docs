...
The following example describes an *insurance* price calculator based on an applicant's age and accident history. You can check the DMN model at https://github.com/IBM/bamoe-docs/blob/9.2.x/_code/docs/dmn/insurance-pricing.dmn[insurance-pricing.dmn].
...
----
https://github.com/IBM/bamoe-docs/blob/9.2.x/_code/docs/dmn/insurance-pricing.dmn
----
