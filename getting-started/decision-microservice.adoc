...
The following example describes an *insurance* price calculator based on an applicant's age and accident history. You can check the DMN model at https://github.com/bamoe/bamoe-docs-source-code-examples/tree/{VERSION_X}/dmn/insurance-pricing.dmn[GitHub].
...
[source,console]
----
https://raw.githubusercontent.com/bamoe/bamoe-docs-source-code-examples/{VERSION_X}/dmn/insurance-pricing.dmn
----
