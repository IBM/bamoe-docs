...
.DMN Decision Table
image::../images/99_images/business_automation/dmn/insurance-price-dt.png[Completed Decision Table,600]
...
image::../images/99_images/business_automation/dmn/insurance-price-drd.png[Insurance Pricing Requirements Diagram, 600]
...
+
image::../images/99_images/business_automation/dmn/raw-dmn-button.png[Raw DMN click]
+
----
...
+
image::../images/99_images/business_automation/dmn/import-dmn.png[Import DMN]
...
+
image::../images/99_images/business_automation/dmn/imported-dmn.png[Sandbox Model]

. You can then click the **Run** button to get a local copy of this DMN running within the browser session itself.
+
image::../images/99_images/business_automation/dmn/dmn-run.png[Run DMN]
...
====
+
image::../images/99_images/business_automation/dmn/form-input-exec.png[Form inputs]
...
+
image::../images/99_images/business_automation/dmn/policy-price-importing-items.png[Policy Pricing Import Asset,600px]

. In the **Create new Uploaded file** dialog, enter `insurance-pricing.dmn` in the **Uploaded file** field:
+
image::../images/99_images/business_automation/dmn/insurance-pricing-dmn-name.png[Filled out import,600px]
...
+
image::../images/99_images/business_automation/dmn/insurance-pricing-drd-added.png[Pricing DRD,600]
...
+
image::../images/99_images/business_automation/dmn/insurance-pricing-dmn-added.png[[Pricing imported,600]
...
+
image::../images/99_images/business_automation/dmn/policy-price-container.png[Container deployed for DMN in KIE Server,600]
