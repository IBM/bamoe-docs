...
. **Update the `src/main/resources/application.properties` file to enable license tracking by adding the following properties, depending on your licensed product: {PRODUCT_DM} or {PRODUCT_PAM}, see xref:../installation/licensing.adoc [Licensing Overview]:**
+
[source,properties]
----
