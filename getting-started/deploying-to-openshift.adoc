...
== Deployment Options
Use the following methods to deploy a  business application to OpenShift:
* <<build_and_deploy_on_openShift>>
* <<build_locall_with_docker_and_automatically_deploy_on_openShift>>
* <<build_locall_with_docker_and_create_manual_deployment_on_openShift>>
...
. **Update the `src/main/resources/application.properties` file to enable the creation of an OpenShift Route by adding the following properties (more info https://quarkus.io/guides/deploying-to-openshift#exposing_routes[here]):**
+
[source,properties]
----
# OpenShift
...
. **Update the `src/main/resources/application.properties` file with the following properties to configure the image and enable the creation of an OpenShift Route (more info https://quarkus.io/guides/deploying-to-openshift#exposing_routes[here]):**
+
[source,properties]
----
