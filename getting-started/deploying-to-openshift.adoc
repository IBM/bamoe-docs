...
. **Update the `src/main/resources/application.properties` file to enable the creation of an OpenShift Route by adding the following properties (more info https://quarkus.io/version/3.20/guides/deploying-to-openshift#exposing_routes[here]):**
+
[source,properties]
----
# OpenShift
...
. **Update the `src/main/resources/application.properties` file with the following properties to configure the image and enable the creation of an OpenShift Route (more info https://quarkus.io/version/3.20/guides/deploying-to-openshift#exposing_routes[here]):**
+
[source,properties]
----
...
- https://quarkus.io/version/3.20/guides/container-image
- https://quarkus.io/version/3.20/guides/deploying-to-openshift
