...
* https://github.com/apache/incubator-kie-kogito-examples/tree/stable/kogito-quarkus-examples/process-business-rules-quarkus[`process-business-rules-quarkus`]: A quickstart project that shows the use of business rules and processes
...
* https://github.com/apache/incubator-kie-kogito-examples/tree/stable/kogito-quarkus-examples/process-error-handling[`process-error-handling`]: A simple usage scenario of the Error Handling Strategy
