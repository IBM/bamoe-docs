...
For more {PRODUCT} examples that use Decisions orchestrated by Workflows, see the following example applications which are included in the xref:../getting-started/examples.adoc[examples package]:
