...
Following are the {PRODUCT} examples that use decisions orchestrated by processes. For more information, see xref:..editing/authoring-scesim.adoc[Example applications]:
