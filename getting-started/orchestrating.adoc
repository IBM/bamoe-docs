...
image::traffic-violation-dmn.png[Image of traffic TrafficViolation.dmn file,480]
...
image::license-validation-drl-businessrule.png[Image of license validation task (DRL),240]
...
image::traffic-violation-dmn-businessrule.png[Image of traffic violation task (DMN),240]
...
* `process-decisions-rest-quarkus`: An example project that shows the usage of decisions within processes. The project focuses on how to integrate decisions in a remote way using REST API endpoints where they can be deployed and decoupled from the process service.
