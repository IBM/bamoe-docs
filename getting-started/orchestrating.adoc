...
<<<<<<< HEAD
To view the complete project, you can refer to the https://github.com/apache/incubator-kie-kogito-examples/tree/main/kogito-quarkus-examples/process-decisions-quarkus[`process-decisions-quarkus`] example application for Quarkus.
||||||| parent of ed92dc1 (Addressing @veena-ux comments in orchestrating.adoc)
To view the complete project, you can refer to the https://github.com/kiegroup/kogito-examples/tree/main/kogito-quarkus-examples/process-decisions-quarkus[`process-decisions-quarkus`] example application for Quarkus.
=======
To view the complete project, se the https://github.com/kiegroup/kogito-examples/tree/main/kogito-quarkus-examples/process-decisions-quarkus[`process-decisions-quarkus`] example application for Quarkus.
>>>>>>> ed92dc1 (Addressing @veena-ux comments in orchestrating.adoc)
...
For more {PRODUCT} examples that use decisions orchestrated by processes, see the following example applications in GitHub:
...
* https://github.com/apache/incubator-kie-kogito-examples/tree/stable/kogito-quarkus-examples/process-error-handling[`process-error-handling`]: An usage scenario of the Error Handling Strategy
