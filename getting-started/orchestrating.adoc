...
* https://github.com/kiegroup/kogito-examples/tree/stable/kogito-quarkus-examples/process-business-rules-quarkus[`process-business-rules-quarkus`]: A quickstart project that shows the use of business rules and processes
* https://github.com/kiegroup/kogito-examples/tree/stable/kogito-quarkus-examples/process-decisions-rest-quarkus[`process-decisions-rest-quarkus`]: An example project that shows the usage of decisions within processes. The focus here is to show how to integrate decisions in a remote way using REST APIs where they can be deployed decoupled from the process service.
* https://github.com/kiegroup/kogito-examples/tree/stable/kogito-quarkus-examples/process-decisions-rules-quarkus[`process-decisions-rules-quarkus`]: An example project that shows the usage of decisions within processes. The focus here is to show how to integrate decisions in an embedded way using Business Rule Task where they must be deployed together with the process.
* https://github.com/kiegroup/kogito-examples/tree/stable/kogito-quarkus-examples/process-error-handling[`process-error-handling`]: A simple usage scenario of the Error Handling Strategy
