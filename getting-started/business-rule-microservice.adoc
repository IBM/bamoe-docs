...
. In the Maven project that we created in the xref:../getting-started/project-setup.adoc[Initial Project Setup and Walkthrough] section, navigate to the `src/main/java/com/ibm` folder and add the following `Person.java` file:
+
--
