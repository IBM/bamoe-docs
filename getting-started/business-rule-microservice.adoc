...
In VSCode, you can add the {VS_CODE_BUNDLE_LINK}[*{VS_CODE_BUNDLE}*] to design the decision requirements diagram (DRD), boxed expression, and data types with the DMN modeler.
