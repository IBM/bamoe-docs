...
. In the Maven project that was created in the xref:../getting-started/project-setup.adoc[Initial Business Service project setup] section, navigate to the `src/main/java/com/ibm` folder and add the following `Person.java` file:
+
