...
After you create your project, you can create or import Decision Model and Notation (DMN) decision models and Drools Rule Language (DRL) business rules in the `src/main/resources` folder of your project. You can also include Java classes in the `src/main/java` folder of your project that act as Java services or provide implementations that can be called from decisions. You can learn about the process in the following sections:

* DMN model example description
* Procedure
...
== Decision Model and Notation model example description
...
. In the Maven project that was created in the xref:../getting-started/project-setup.adoc[Business Service project setup] section, navigate to the `src/main/java/com/ibm` folder and add the following `Person.java` file:
+
...
To create described DMN model example in VS Code using the DMN Editor, follow these steps:
