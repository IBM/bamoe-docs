...
== Source Control
{CANVAS}, a standalone editor for BAMOE files, only works with git.
...
More information about installing and using {CANVAS} can be found later in this documentation.
