...
[NOTE]
====
Spring Boot is supported for Decisions, Rules, and spreadsheet Decision Tables services, however there is no Accelerator yet available for this framework. To get started with Spring Boot you can use {BAMOE_DOCS_EXAMPLES_DOCS_LINK}/spring-boot/decisions/pom.xml[this sample pom.xml for Decisions.] or {BAMOE_DOCS_EXAMPLES_DOCS_LINK}/spring-boot/rules/pom.xml[this sample pom.xml for Rules].
====
