...
It includdes capabilities for monitoring, administration, and management of business automation assets.
...
Though all the guided editors are deprecated in {PRODUCT} version {VERSION}, you do not loose all your effort into building those assets.
...
Select the converted file and choose one of the Download buttons in Business Central, which download the converted spreadsheet file to your local machine. You can add this file to src/main/resources folder of your Maven project.
