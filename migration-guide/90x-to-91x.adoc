...
This migration guide will show two ways of migrating your project. One way of migrating is by creating a new project from scratch and then moving the assets to it.
In the other way, you will be updating an existing BAMOE version {VERSION_90X} project.
...
See xref:../introduction/release-notes/version-mapping-9-1-1.adoc[version mapping for {PRODUCT} version 9.1.1]
