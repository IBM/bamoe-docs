...
The other way is by updating an existing BAMOE version {VERSION_90X} project.
The next step is to set up the Maven configuration.
...
20   <kogito.bom.version>{BOM_VERSION_911}</kogito.bom.version>
21 </properties>
----
