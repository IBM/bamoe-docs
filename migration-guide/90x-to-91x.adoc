...
{PRODUCT} Version {VERSION_91x} which follows the {PRODUCT} Version {VERSION_910}, is optimized for a hybrid cloud environment, and adapts to your domain and tooling needs.
