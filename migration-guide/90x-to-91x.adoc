...
+
In the {PRODUCT_SHORT} Version {VERSION_901} the Quarkus version was 2.16 and for Version {VERSION_911} it is 3.8.6.
...
----
+
Now, you can start using your {PRODUCT_SHORT} version {VERSION_910} project.
