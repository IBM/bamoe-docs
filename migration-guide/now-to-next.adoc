...
[start=3]
.  Add the following `properties` to the `pom.xml` file, using the following numbers as a guide.
...
The following table is useful in determining various Maven versions to be referenced in your `pom.xml`: 
...
After the project has been generated, you must see the project structure in VS Code, similar to the following diagram:
