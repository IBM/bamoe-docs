...
This includes not only creating and publishing the new project to an enterprise GIT repository and configuring your CI/CD pipeline to pull from GIT, perform a Maven build/test/deploy, etc.
...
Refer to xref:drl.html[Drools Rule Language Migration] for migration to the latest version of Drools Rule Language (DLR).
====
