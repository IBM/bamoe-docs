...
[start=4]
. Replace lines 32-34, which are essentially adding the `bamoe-bom` to the list of imported dependencies:

+
[source,xml]
----
31      <dependency>
32  ---   <groupId>${quarkus.platform.group-id}</groupId>
33  ---   <artifactId>quarkus-kogito-bom</artifactId>
34  ---   <version>${quarkus.platform.version}</version>
