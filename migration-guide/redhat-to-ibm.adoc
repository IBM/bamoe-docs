...
The following tools are required in order to migrate to {PRODUCT_SHORT} version {VERSION_910}:
...
From there, depending on what you need to get, you will download a few files _(replace with the most current version)_.
The most common ones are highlighted below, but download whichever makes the most sense for your environment. 
