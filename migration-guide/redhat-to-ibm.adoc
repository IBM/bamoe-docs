...
[NOTE]
====
{PRODUCT_SHORT} version {VERSION_80}'s database is compatible with {RH_PAM} 7.13, so all you need to do is update the database to that level, and you will be set to migrate the rest of your application.
====
