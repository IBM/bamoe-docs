...
| This archive is an executable file that installs {PRODUCT_SHORT} {VERSION_803} in a preinstalled Red Hat JBoss EAP on all supported Linux and Windows environments.
