...
The following tools are required in order to migrate to {PRODUCT_SHORT} version {VERSION_80x}:
...
In the table above, you should replace **VERSION** with the version of {PRODUCT_SHORT} you are migrating to, such as {VERSION_8_LATEST}.
====
