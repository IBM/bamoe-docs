...
{MAVEN_SITE_URL_BASE}[Apache Maven] is a software project management and comprehension tool.
...
You can use the same automated update tool to apply both patch updates and minor release upgrades to {PRODUCT} v{VERSION_OLD}.
Patch updates of {PRODUCT}, such as an update from version 8.0 to 8.0.3, include the latest security updates and bug fixes.
Minor release upgrades, such as an upgrade from version 8.0.x to 8.1, will include enhancements, security updates, and bug fixes.
