...
It is recommended that you follow this migration path before attempting to migrate to the next generation of the product known as {PRODUCT} v{VERSION_OLD}.  
...
[TIP]
====
Once Business Central and KIE Server have been updated, all assoicated KJARs need to be recreated and redeployed. This is important because they have been modified with the upgrade and should be re-tested.
====
