...
This section describes how to migrate your existing business automation applications and platforms to the most recent version of IBM Business Automation Manager Open Editions. The supported upgrade process is from the previous version to the current version. If you are migrating from an older version, you must follow the migration steps to upgrade to each intermediate version, as documented. Depending on the complexity of your installation, you might want IBM® Services to participate in your project. If so, contact your IBM service representative.
