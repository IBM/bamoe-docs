...
* xref:now-to-next.html[{PRODUCT} v{VERSION_80} {PRODUCT} v{VERSION_901}] for migration from {PRODUCT_LONG} Version {VERSION_80} to {PRODUCT_LONG} Version {VERSION_901}.
...
[NOTE]
====
{PRODUCT_LONG} v{PRODUCT_VERSION} is based solely on the Apache KIE module known as  https://kogito.kie.org/[the Kogito Initiative], and is currently limited to decision management features such as Decision Model and Notation (DMN), Drools Rule Language (DRL), and Predictive Model Markup Language (PMML). 
