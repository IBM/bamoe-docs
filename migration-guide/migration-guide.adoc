...
* xref:{RH_BPMS_MIGRATION_DOC_LINK}[Red Hat version 6 to version 7] for migration from {RH_BPMS} to v7 of the former Red Hat offerings of {RH_PAM} and/or {RH_DM}.
...
* xref:now-to-next.html[{PRODUCT} version {VERSION_80} {PRODUCT} version {VERSION_90X}] for migration from {PRODUCT_LONG} version {VERSION_80} to {PRODUCT_LONG} version {VERSION_90X}.
* xref:90x-to-91x.html[{PRODUCT} version {VERSION_90X} {PRODUCT} version {VERSION}] for migration from {PRODUCT_LONG} version {VERSION_90X} to {PRODUCT_LONG} version {VERSION}.
