...
//
include::{shared-dir}/Workbench/RemoteAPI/security-management-rest-api-roles-ref.adoc[leveloffset=+1]

include::{shared-dir}/Workbench/RemoteAPI/kie-server-rest-api-process-queries-ref.adoc[leveloffset=+2]
//
ifdef::PAM[]
