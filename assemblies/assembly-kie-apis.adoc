...
//
include::{shared-dir}/KieServer/kie-server-rest-api-process-queries-introduction.adoc[leveloffset=+1]

include::{shared-dir}/KieServer/kie-server-rest-api-process-queries-ref.adoc[leveloffset=+2]
//
ifdef::PAM[]
