...
* {PRODUCT} is installed and configured with {KIE_SERVER}. For more information see {URL_INSTALLING_AND_CONFIGURING}assembly-install-on-eap.html[_{INSTALLING_ON_EAP}_].
//xreflink
* {PRODUCT} is running and you can log in to {CENTRAL} with the `developer` role. For more information, see {URL_INSTALLING_AND_CONFIGURING}assembly-planning.html[_{PLANNING_INSTALL}_].
...
* {URL_DEVELOPING_DECISION_SERVICES}/assembly-dmn-models.html[_{DMN_MODELS}_]
* {URL_DEVELOPING_DECISION_SERVICES}/assembly-test-scenarios.html[_{TESTING_DECISION_SERVICE}_]
* {URL_DEPLOYING_AND_MANAGING_SERVICES}/assembly-managing-projects.html[_{MANAGING_PROJECTS}_]
