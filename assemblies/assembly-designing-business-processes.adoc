...
include::{jbpm-dir}/BPMN2/managing-events-using-correlation-feature.adoc[leveloffset=+1]
...
* {URL_GETTING_STARTED}/assembly-getting-started-process-services.html[_{GETTING_STARTED_PROCESSES}_]
* {URL_DEVELOPING_PROCESS_SERVICES}/assembly-managing-and-monitoring-business-processes.html[_{MANAGING_PROCESSES}_]
* {URL_DEVELOPING_PROCESS_SERVICES}/assembly-interacting-with-processes.html[_{INTERACTING_PROCESSES_TASKS}_]
