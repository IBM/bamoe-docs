...
* xref:assembly-getting-started-process-services.html[_{GETTING_STARTED_PROCESSES}_]
* xref:assembly-managing-and-monitoring-business-processes.html[_{MANAGING_PROCESSES}_]
* xref:assembly-interacting-with-processes.html[_{INTERACTING_PROCESSES_TASKS}_]
