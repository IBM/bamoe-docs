...
.Prerequisites
* You have reviewed the information in {URL_INSTALLING_AND_CONFIGURING}/assembly-planning.html[_{PLANNING_INSTALL}_].
...
//* {URL_INTEGRATING}/assembly-integrating-codeready-studio.html[_{INTEGRATING_CRS}_]

== Next steps
* {URL_INTEGRATING}/assembly-integrating-sso.html[_{INTEGRATING_SSO}_]
ifdef::DM[]
* {URL_GETTING_STARTED}/assembly-getting-started-decision-services.html[_{GETTING_STARTED_DECISION_SERVICE}_]
endif::DM[]
