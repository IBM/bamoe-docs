...
* A project with business assets has been created in {PRODUCT} and deployed to a {KIE_SERVER}. For instructions, see xref:assembly-packaging-deploying.html[_{PACKAGING_DEPLOYING_PROJECT}_].
* One or more {KIE_SERVERS} are running and contain deployed project data. For instructions, see xref:assembly-packaging-deploying.html[_{PACKAGING_DEPLOYING_PROJECT}_].
