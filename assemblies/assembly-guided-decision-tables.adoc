...
* {URL_GETTING_STARTED}/assembly-getting-started-decision-services.html[_{GETTING_STARTED_DECISION_SERVICE}_] (step-by-step tutorial with a DMN decision service example)
* {URL_DEVELOPING_DECISION_SERVICES}/assembly-dmn-models.html[_{DMN_MODELS}_] (overview of DMN support and capabilities in {PRODUCT})
====

.Prerequisites
* The space and project for the guided decision tables have been created in {CENTRAL}. Each asset is associated with a project assigned to a space. For details, see {URL_GETTING_STARTED}/assembly-getting-started-decision-services.html[_{GETTING_STARTED_DECISION_SERVICE}_].
