...
* {PRODUCT} is installed. For more information, see {URL_INSTALLING_AND_CONFIGURING}/assembly-planning.html[_{PLANNING_INSTALL}_].
* {PRODUCT} is running and you can log in to {CENTRAL} with the `admin` role. For more information, see {URL_INSTALLING_AND_CONFIGURING}/assembly-planning.html[_{PLANNING_INSTALL}_].

ifdef::PAM[]
[NOTE]
====
For information about managing and monitoring business processes that run on {KIE_SERVER}, see {URL_DEVELOPING_PROCESS_SERVICES}/assembly-managing-and-monitoring-business-processes.html[_{MANAGING_PROCESSES}_].
====
endif::PAM[]
...
For more information about running {PRODUCT} in a {EAP_LONG} clustered environment, see {URL_INSTALLING_AND_CONFIGURING}/assembly-clustering-eap.html[_{INSTALLING_ON_EAP_CLUSTER}_].
...
* {URL_INSTALLING_AND_CONFIGURING}/assembly-install-on-eap.html[_{INSTALLING_ON_EAP}_]
