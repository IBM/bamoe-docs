...
include::{enterprise-dir}/installation/preemptive-authentication-for-local-projects-proc.adoc[leveloffset=+1]
...
include::{jbpm-dir}/Persistence/process-variables-persist-proc.adoc[leveloffset=+1]
...
include::{shared-dir}/KieServer/kie-server-system-properties-con.adoc[leveloffset=+1]
...
include::{shared-dir}/KieServer/performance-tuning-kie-server-con.adoc[leveloffset=+1]

== Additional resources
* xref:assembly-install-on-eap.html[_{INSTALLING_ON_EAP}_]
* xref:assembly-planning.html[_{PLANNING_INSTALL}_]
* xref:assembly-install-on-eap.html[_{INSTALLING_ON_EAP}_]
* xref:../deploying-on-openshift.adoc[_{DEPLOYING_OPENSHIFT_OPERATOR}_]
//* xref:../deploying-on-openshift.adoc[_{DEPLOYING_OPENSHIFT_TEMPLATES}_]
