...
.Prerequisites
* The space and project for the decision tables have been created in {CENTRAL}. Each asset is associated with a project assigned to a space. For details, see xref:assembly-getting-started-decision-services.html[_{GETTING_STARTED_DECISION_SERVICE}_].
