...
NOTE: You can upgrade from Red Hat Process Automation Manager (RHPAM) 7.13.5 directly to any BAMOE 8.0.x version. For older RHPAM versions (prior to 7.13.5), you must first upgrade to BAMOE 8.0.0 before moving to later 8.0.x releases.
