...
If your current application is based on the legacy product known as {RH_BPMS}, you must first bring your installation up to the latest release of {RH_PAM} / {RH_DM} version 7 before performing any upgrade to {PRODUCT}.
...
- https://maven.apache.org[Apache Maven 3.8.6] or later 3.8.x version.
//- https://maven.apache.org[Apache Maven 3.8.6] or later is installed.

[NOTE]
====
Currently it is https://github.com/quarkusio/quarkus/issues/31011[not possible to create a project with Quarkus xx and Maven 3.9.0].
====
//[IMPORTANT]
