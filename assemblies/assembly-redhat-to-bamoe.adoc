...
If your current application is based on the legacy product known as {RH_BPMS}, for an in-place upgradation you must first bring your installation up to the latest release of {RH_PAM} / {RH_DM} version 7 before performing any upgrade to {PRODUCT}.
