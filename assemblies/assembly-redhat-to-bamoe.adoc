...
To install the new versions of Business Central, KIE Server, and the headless controller in a duplicate environment, follow the instructions in xref:../installing-and-configuring.html[Installing and configuring].
...
* Download `bamoe-8.0.x-add-ons.zip` and extract the file to a temporary directory.
