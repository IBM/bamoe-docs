...
Your project data and settings in Business Central (stored in the `.niogit` directory) can be migrated using the migration tooling (see xref:#niogit-directory). 
