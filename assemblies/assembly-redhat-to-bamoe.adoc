...
[source,shell]
----
cp -r /$RHPAM_7.13.5_HOME/bin/.niogit  /$BAMOE_8.0_HOME/bin/
----
+
...
. Download {PRODUCT_SHORT} 8.0.x Add-Ons and extract the downloaded `bamoe-8.0.x-add-ons.zip` file to a temporary directory. 
