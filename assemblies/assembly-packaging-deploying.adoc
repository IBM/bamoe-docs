...
.Prerequisites
* The project to be deployed has been developed and tested. For projects in {CENTRAL}, consider using test scenarios to test the assets in your project. For example, see xref:assembly-test-scenarios.html[_{TESTING_DECISION_SERVICE}_].
...
* xref:assemblies/assembly-guided-decision-tables.html["Executing rules" in _{DRL_RULES}_]
* xref:assemblies/assembly-kie-apis.html[_{KIE_APIS}_]
