...
.Prerequisites
* The project to be deployed has been developed and tested. For projects in {CENTRAL}, consider using test scenarios to test the assets in your project. For example, see {URL_DEVELOPING_DECISION_SERVICES}/assembly-test-scenarios.html[_{TESTING_DECISION_SERVICE}_].
...
* {URL_DEVELOPING_DECISION_SERVICES}/assembly-guided-decision-tables.html["Executing rules" in _{DRL_RULES}_]
