...
* Business rules and their associated data objects have been defined for the rules-based decision service. For details, see xref:assembly-guided-decision-tables.html[_{GUIDED_DECISION_TABLES}_].
