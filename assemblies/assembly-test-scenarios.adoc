...
.Prerequisites
* The space and project for the decision service have been created in {CENTRAL}. For details, see {URL_GETTING_STARTED}/assembly-getting-started-decision-services.html[_{GETTING_STARTED_DECISION_SERVICE}_].
* Business rules and their associated data objects have been defined for the rules-based decision service. For details, see {URL_DEVELOPING_DECISION_SERVICES}/assembly-guided-decision-tables.html[_{GUIDED_DECISION_TABLES}_].
* DMN decision logic and its associated custom data types have been defined for the DMN-based decision service. For details, see {URL_DEVELOPING_DECISION_SERVICES}/assembly-dmn-models.html[_{DMN_MODELS}_].
