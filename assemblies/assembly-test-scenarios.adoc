...
.Prerequisites
* The space and project for the decision service have been created in {CENTRAL}. For details, see xref:assembly-getting-started-decision-services.html[_{GETTING_STARTED_DECISION_SERVICE}_].
* Business rules and their associated data objects have been defined for the rules-based decision service. For details, see xref:assemblies/assembly-guided-decision-tables.html[_{GUIDED_DECISION_TABLES}_].
* DMN decision logic and its associated custom data types have been defined for the DMN-based decision service. For details, see xref:assemblies/assembly-dmn-models.html[_{DMN_MODELS}_].
