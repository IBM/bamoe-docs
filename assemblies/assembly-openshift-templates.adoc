...
[NOTE]
====
For instructions about deploying an {PRODUCT} environment on {OPENSHIFT} {OPENSHIFT_VERSION_SHORT} using Operators, see xref:assembly-openshift-operator.html[_{DEPLOYING_OPENSHIFT_OPERATOR}_].
====
