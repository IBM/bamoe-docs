...
[NOTE]
====
For instructions about deploying an {PRODUCT} environment on {OPENSHIFT} {OPENSHIFT_VERSION_SHORT} using Operators, see {URL_DEPLOYING_ON_OPENSHIFT}/assembly-openshift-operator.html[_{DEPLOYING_OPENSHIFT_OPERATOR}_].
====
...
[NOTE]
====
Do not use {PRODUCT} templates with {OPENSHIFT} {OPENSHIFT_VERSION_SHORT}.x. To deploy {PRODUCT} on {OPENSHIFT} {OPENSHIFT_VERSION_SHORT}.x, see the instructions in {URL_DEPLOYING_ON_OPENSHIFT}/assembly-openshift-operator.html[_{DEPLOYING_OPENSHIFT_OPERATOR}_].
====
///
