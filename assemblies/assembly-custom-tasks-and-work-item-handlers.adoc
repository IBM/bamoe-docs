...
include::{jbpm-dir}/BPMN2/custom-tasks-work-item-definitions-vscode.adoc[leveloffset=+1]

include::{jbpm-dir}/BPMN2/custom-tasks-creating-work-item-handler-projects.adoc[leveloffset=+1]

include::{jbpm-dir}/BPMN2/custom-tasks-work-item-handler-project-customization.adoc[leveloffset=+1]
