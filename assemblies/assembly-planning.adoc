...
.Integration
* xref:assembly-springboot-business-apps.html[_{CREATING_SPRING_BOOT_APPLICATIONS}_]
* xref:assembly-integrating-fuse.html[_{INTEGRATING_FUSE}_]
* xref:assembly-integrating-sso.html[_{INTEGRATING_SSO}_]
