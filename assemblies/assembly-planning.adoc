...
* xref:assembly-clustering-eap.html[_{INSTALLING_ON_EAP_CLUSTER}_]
* xref:assembly-install-on-jws.html[_{INSTALLING_ON_JWS}_]
* xref:assembly-installing-kie-server-on-was.html[_{INSTALLING_KIE_ON_WAS}_]
* xref:assembly-installing-kie-server-on-wls.html[_{INSTALLING_KIE_ON_WLS}_]
