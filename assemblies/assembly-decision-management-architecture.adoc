...
* xref:assemblies/assembly-planning.html[_{PLANNING_INSTALL}_]
* xref:assemblies/assembly-getting-started-decision-services.html[_{GETTING_STARTED_DECISION_SERVICE}_]
//* {URL_GETTING_STARTED}/assembly-getting-started-business-optimizer.html[_{GETTING_STARTED_PLANNER}_]
ifdef::PAM[]
* xref:assemblies/assembly-getting-started-process-services.html[_{GETTING_STARTED_PROCESSES}_]
endif::[]
