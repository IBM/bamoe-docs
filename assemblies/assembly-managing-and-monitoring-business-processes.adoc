...
* {PRODUCT} is running and you can log in to {CENTRAL} with the `process-admin` role. For more information, see {URL_INSTALLING_AND_CONFIGURING}/assembly-planning.html[_{PLANNING_INSTALL}_].
