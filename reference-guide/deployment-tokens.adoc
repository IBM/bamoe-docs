...
Tokens inject dynamic values into your manifests at deploy time. Use the `${{ }}` syntax with a JSON Path expression (following xref:https://datatracker.ietf.org/doc/html/rfc9535[RFC 9535]) to reference values.
