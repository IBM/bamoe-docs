...
image::reference-guide/boxed-filter.png[width=480]

.Boxed iterator function
image::reference-guide/boxed-iterator.png[width=480]
...
.Number function
image::reference-guide/number-function.png[width=480]
...
image::reference-guide/valuepropdate-and-time-conversion-function.png[width=480]
...
.Value Property page on {CANVAS}
image::reference-guide/valuepropertypage.png[width=480]

.Input and Output
image::reference-guide/input-output.png[width=480]
