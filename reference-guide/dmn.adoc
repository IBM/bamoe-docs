...
You can design your DMN models with {CANVAS} or {PRODUCT_SHORT} Developer Tools for VS Code, or import existing DMN models into your _Business Service_ projects for deployment and execution.
...
NOTE: The `allowedValues` tag has been deprecated in the 1.5 DMN version.
...
.Boxed filter function
image::reference-guide/boxed-filter.png[width=600]

.Boxed iterator function
image::reference-guide/boxed-iterator.png[width=600]
...
.Number function
image::reference-guide/number-function.png[width=600]
...
|date and time(date("2024-12-24"), time("23:59:00"), "America/Costa_Rica")|2024-12-24T23:59:00@America/Costa_Rica
|===

.Date and time conversion function
image::reference-guide/date-and-time-conversion-function.png[width=600]
...
* date: Converts a calendar date into a date-time value where the time is set to UTC midnight. For example, `date(2025, 7, 3).value` returns `BigDecimal.valueOf(1719028057)`.
...
For example, `date and time("2025-07-03T01:01:01Z").value` returns `BigDecimal.valueOf(1759449661)`.
...
.ValueProperty page on {CANVAS}
image::reference-guide/valuepropertypage.png[width=600]

.Inputs and outputs variables
image::reference-guide/input-output.png[width=600]
