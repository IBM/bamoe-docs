...
To manage dependency versions and configurations, include the appropriate Bill of Materials (BOM) in the dependencyManagement section of your project's POM.
