...
To facilitate version management and simplify upgrades, {PRODUCT_SHORT} provides different Bills of Materials that adhere to Maven best practices.

Bill of Materials is a collection of fully supported libraries that can be used in _Business Service_ projects.

For more information on Maven BOM, see https://maven.apache.org/guides/introduction/introduction-to-dependency-mechanism.html#Bill_of_Materials_.28BOM.29_POMs[Bill 
of Materials (BOM) POMs guide].

To manage dependency versions and configurations, include the appropriate Bill of Materials (BOM) in the `dependencyManagement` section of your _Business Service_ project's POM.
