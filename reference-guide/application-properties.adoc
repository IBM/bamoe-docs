...
There are a number of different properties available in a _Business Service_ project, below is a listing of those properties, a short description, the corresponding Java type and a default, if one exists.
