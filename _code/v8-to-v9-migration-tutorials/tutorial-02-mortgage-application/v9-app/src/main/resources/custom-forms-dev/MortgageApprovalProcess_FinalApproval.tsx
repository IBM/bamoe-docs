...
const Form__MortgageApprovalProcess_FinalApproval: React.FC<any> = (
	props: any
) => {
    ...
    */
	...
	return (
		<div className={'pf-v5-c-form'}>
				...
				<CardBody className='pf-v5-c-form'>
					...
					<Card>
						<CardBody className='pf-v5-c-form'>
							...
							<FormGroup
								fieldId={'uniforms-000e-0006'}
								label={'Address'}
								isRequired={false}>
								<TextInput
									name={'application.applicant.address'}
									id={'uniforms-000e-0006'}
									isDisabled={true}
									placeholder={''}
									type={'text'}
							...
							<FormGroup
								fieldId={'uniforms-000e-000b'}
								label={'Name'}
								isRequired={false}>
								<TextInput
									name={'application.applicant.name'}
									id={'uniforms-000e-000b'}
									isDisabled={true}
									placeholder={''}
									type={'text'}
					...
					<Card>
						<CardBody className='pf-v5-c-form'>
							...
							<FormGroup
								fieldId={'uniforms-000e-000i'}
								label={'Error'}
								isRequired={false}>
								<TextInput
									name={'application.errors.error'}
									id={'uniforms-000e-000i'}
									isDisabled={true}
									placeholder={''}
									type={'text'}
					...
					<Card>
						<CardBody className='pf-v5-c-form'>
							...
							<FormGroup
								fieldId={'uniforms-000e-000n'}
								label={'Address'}
								isRequired={false}>
								<TextInput
									name={'application.property.address'}
									id={'uniforms-000e-000n'}
									isDisabled={true}
									placeholder={''}
									type={'text'}
							...
							<FormGroup
								fieldId={'uniforms-000e-000q'}
								label={'Locale'}
								isRequired={false}>
								<TextInput
									name={'application.property.locale'}
									id={'uniforms-000e-000q'}
									isDisabled={true}
									placeholder={''}
									type={'text'}
			...
			<FormGroup fieldId='uniforms-000e-000u'>
				<Checkbox
					isChecked={inlimit}
					isDisabled={true}
					id={'uniforms-000e-000u'}
					name={'inlimit'}
					label={'Inlimit'}
...
export default Form__MortgageApprovalProcess_FinalApproval;
