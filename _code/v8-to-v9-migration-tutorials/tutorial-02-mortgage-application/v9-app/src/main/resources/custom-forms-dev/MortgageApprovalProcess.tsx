...
const Form__MortgageApprovalProcess: React.FC<any> = (props: any) => {
    ...
    */
	...
	return (
		<div className={'pf-v5-c-form'}>
				...
				<CardBody className='pf-v5-c-form'>
					...
					<Card>
						<CardBody className='pf-v5-c-form'>
							...
							<FormGroup
								fieldId={'uniforms-000a-000b'}
								label={'Name'}
								isRequired={false}>
								<TextInput
									name={'application.applicant.name'}
									id={'uniforms-000a-000b'}
									isDisabled={false}
									placeholder={''}
									type={'text'}
					...
					<Card>
						<CardBody className='pf-v5-c-form'>
							...
							<FormGroup
								fieldId={'uniforms-000a-000i'}
								label={'Error'}
								isRequired={false}>
								<TextInput
									name={'application.errors.error'}
									id={'uniforms-000a-000i'}
									isDisabled={false}
									placeholder={''}
									type={'text'}
					...
					<Card>
						<CardBody className='pf-v5-c-form'>
							...
							<FormGroup
								fieldId={'uniforms-000a-000n'}
								label={'Address'}
								isRequired={false}>
								<TextInput
									name={'application.property.address'}
									id={'uniforms-000a-000n'}
									isDisabled={false}
									placeholder={''}
									type={'text'}
							...
							<FormGroup
								fieldId={'uniforms-000a-000q'}
								label={'Locale'}
								isRequired={false}>
								<TextInput
									name={'application.property.locale'}
									id={'uniforms-000a-000q'}
									isDisabled={false}
									placeholder={''}
									type={'text'}
			...
			<FormGroup fieldId='uniforms-000a-000u'>
				<Checkbox
					isChecked={incdownpayment}
					isDisabled={false}
					id={'uniforms-000a-000u'}
					name={'incdownpayment'}
					label={'Incdownpayment'}
					onChange={(e, newValue) => set__incdownpayment(newValue)}
				/>
			</FormGroup>
			<FormGroup fieldId='uniforms-000a-000w'>
				<Checkbox
					isChecked={inlimit}
					isDisabled={false}
					id={'uniforms-000a-000w'}
					name={'inlimit'}
					label={'Inlimit'}
...
export default Form__MortgageApprovalProcess;
