...
{PRODUCT_LONG} version {VERSION_80} provides a seemless upgrade path for customers and workloads formally leveraging the Red Hat offerings.
By remaining a functionally equivalent product to the Red Hat offering, customers can easily upgrade from the former Red Hat offering once they have purchased an IBM subscription for {PRODUCT}.
