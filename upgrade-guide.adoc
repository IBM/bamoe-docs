...
It is recommended that you follow this migration path before attempting to migrate to the next generation of the product known as {PRODUCT} version 9.1.x.
...
After this migration, you are free to migrate to any release of {PRODUCT_SHORT}.
