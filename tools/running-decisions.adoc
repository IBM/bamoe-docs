...
For this purpose, we will take a closer look on the Decision Service node.
...
NOTE: List of paramaters that Decision Service node requires from the Invocation node can be also seen in the Properties panel **Input data** section of the `payroll` node.
...
There is availavle source code of the https://TODO-ADD-v0.0.1.com[payroll.dmn] example model.
