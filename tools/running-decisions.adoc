...
You can call this capability of running Decision while developing them “DMN Runner”.
...
It is encouraged to keep your Data Types organized for better maintainability of your Decision, and to extract the most of what DMN Runner has to offer.
