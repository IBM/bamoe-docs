...
For more information on configuring custom Accelerators, see xref:../installation/development-environment.adoc#custom-accelerators[Configuring custom Accelerators for your organization]. For more information on using accelerators see xref:../applying-accelerators.adoc[Using Accelerators].
