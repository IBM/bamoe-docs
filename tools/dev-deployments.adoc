...
The resource `name` and `namespace` are set through xref:../tools/create-custom-dev-deployment.adoc#token_interpolation[token interpolation] in the manifest YAML:
