...
NOTE: It is important to note that our Dev Deployment service inside {CANVAS} already applies these required labels and annotations by patching the resource YAMLs.
