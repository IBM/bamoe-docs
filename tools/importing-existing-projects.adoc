...
Uploading Git repositories from your computer will ignore its `.git` directory, meaning that on {CANVAS}, you will be starting a new repository, without any history.
...
Once you're done, you will be brought back to the Import modal, where you can see your account select and the main branch already inferred:
