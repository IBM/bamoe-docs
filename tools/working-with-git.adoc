...
image::tools/cloning-repo.png[width=480]
...
image::tools/importing-repo.png[width=480]
...
image::tools/select-auth-provider.png.png[width=480]
+
...
.Push and Pull changes
image::tools/push-pull.png[width=480]
