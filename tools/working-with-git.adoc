...
The integration features of Git Providers in {CANVAS} enable seamless collaboration and version control, allowing users to efficiently manage their projects and repositories.
...
{CANVAS} supports the following operations across providers:
...
image::tools/cloning-repo.png[width=600]
...
image::tools/importing-repo.png[width=600]
...
image::tools/select-auth-provider.png[width=600]
+
...
.Push and Pull 
image::tools/push-pull.png[width=600]
...
NOTE: Bitbucket Data Center does not support native code snippets therefore snippet-related features are not available for Bitbucket Data Center.
