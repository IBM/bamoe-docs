...
.Deploy dropdown for a project called “my-sample-project” on {CANVAS}
...
image:tools/devDeployments/kubernetes-waiting.png[width=400px] image:tools/devDeployments/kubernetes-done.png[width=400px]
_“Dev deployments dropdown” showing the process of deploying a project called “my-sample-project” on {CANVAS}._

After ~30 seconds, you should be able to see your Dev deployment with a green check.
Clicking the item on this dropdown will take you to a special web application that {CANVAS} provides for Dev deployments.
...
You can change the Decision using the dropdown at the top-right.
