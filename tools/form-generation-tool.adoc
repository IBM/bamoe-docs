...
Please download *{FORM_GENERATION_TOOL}* zip file available https://ibm.ent.box.com/file/1553555206970?s=b6szj4irpd4loz3ji2qrnkaoegvbnezg[here,window=_blank].
...
However, for this documentation, we will use existing https://incubator.apache.org/projects/kie.html[Apache Kie,window=_blank] *jbpm-compact-architecture-example* project available https://ibm.ent.box.com/file/1553555696995?s=9xpzcb3gsylinemjyvi0k7frk6aw5iw6[here,window=_blank].
