...
[NOTE]
====
Currently there is an https://github.com/apache/incubator-kie-issues/issues/836[issue,window=_blank] blocking users from navigating to the *Forms* view. For more information, see xref:../tools/known-limitations.adoc[Known limitations].
====
