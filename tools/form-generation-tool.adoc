...
It is included as a command in the BAMOE Developer Tools extension for VS Code (BAMOE VS Code extension). You can generate web forms for BAMOE and Apache Kie projects.
