...
- Make sure your https://incubator.apache.org/projects/kie.html[Apache Kie,window=_blank] project has been compiled, otherwise the CLI will not be able to find all the form schemas.
...
Let us remove this piece of the source code
[source,html]
----
<div class="alert alert-warning" role="alert">
  ...
  <hr />
  <p class="mb-0">
    Some complex property types, such as <code>Array</code> are not yet supported, however, you can still write your own component into
