...
** xref:dev-deployments.html[Creating Dev Deployments] - describes how to connect to a local or remote Kubernetes instance (or a remote OpenShift instance) to execute your Decisions and Workflows for development purposes only.
...
** xref:editors-libraries.html[DMN and BPMN Editors JavaScript Libraries] - describes how to install and use the new DMN and BPMN Editors and the new DMN Editor. These editors are also available as standalone Javascript libraries that can be embedded into any frontend web application.