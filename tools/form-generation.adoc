...
image::tools/form-gen-generate-form-code.png[generate form code for user tasks,720]
...
image::tools/form-gen-project-folder.png[Select folder,720]
...
image::tools/form-gen-libraries.png[libraries,720]

Next, you must choose whether to generate form code for all User Tasks or specific User Tasks.

image::tools/form-gen-user-tasks.png[user tasks,720]
...
image::tools/form-gen-list-project-user-tasks.png[list of projects user tasks,720]
...
image::tools/form-gen-code-project-folder.png[form code in folder,320]
...
image::tools/form-gen-confirmation.png[confirmation,720]
...
To do so, just add the `com.ibm.bamoe:bamoe-quarkus-devui` dependency in your project's POM file. For the dependency, see xref:../reference-guide/maven-repository-libraries.adoc#_workflows_quarkus_dev_testing[Workflows (Quarkus dev + testing)].
...
image::tools/bamoe-runtime-tools-quarkus-dev-ui.png[BAMOE Quarkus Dev UI Card,320]
