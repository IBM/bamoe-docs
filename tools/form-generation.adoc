...
* *Bootstrap 4*: This type generates *.html* files using the *Bootstrap4* library for styling the forms.
...
For the *Pattern Fly* forms, by default, no additional scripts or styles are loaded.
