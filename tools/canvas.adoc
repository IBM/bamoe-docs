...
You can set the application interface to your preferred language by selecting from the available options in the Canvas settings language dropdown. By default, the language matches your system locale, but you can change it by updating your browser.