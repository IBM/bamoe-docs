...
You can change the {CANVAS} interface language by updating your browser’s language settings or navigating to Settings in {CANVAS}, opening the Language tab, and selecting your preferred language. By default, the {CANVAS} uses your browser settings, but you can select a specific language to override the browser setting. Once configured, all UI elements, including the {CANVAS} homepage and interactive components, will display in the selected language, providing a fully localized experience.