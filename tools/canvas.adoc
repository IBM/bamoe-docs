...
This doesn't mean that you will lose your work if you close your tab or restart your computer, as all changes made on {CANVAS} are persisted in your disk, so you can be assured that your files are safe.
