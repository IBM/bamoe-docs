...
Another unconventional aspect of {CANVAS} is that it does not store any of your information in the Cloud.
Instead, everything you do on {CANVAS} is persisted on your machine, inside your browser.
This does not mean that you will lose your work if you close your tab or restart your computer, as all changes made on {CANVAS} are persisted in your disk, so you can be assured that your files are safe.
