...
You can change the VS Code interface to your preferred language by selecting from the available options in the language dropdown under extension settings. By default, the language matches your VS Code locale, but you can select a different language in the extension settings.
