...
You can set the application interface to your preferred language by selecting from the available options in the language dropdown under Developer Tools extension settings in VS Code. By default, the language matches your system locale, but you can change it by updating your VS Code locale.
