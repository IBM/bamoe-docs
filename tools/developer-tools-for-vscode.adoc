...
Follow this https://blog.kie.org/2021/04/how-to-use-test-scenario-editor-to-test-your-dmn-asset-in-vscode.html[blog post tutorial] to get started with Scenario Simulation on BAMOE Developer Tools.
...
Follow this https://blog.kie.org/2022/05/dmn-types-from-java-classes.html[blog post tutorial] to get started.
