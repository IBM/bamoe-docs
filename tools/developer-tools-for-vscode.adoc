...
+
This is the stable version of the DMN Editor inherited from {PRODUCT_SHORT} {VERSION_80}. This editor can open 1.1, 1.2 and 1.3 versions of DMN, and it saves them to version 1.3.
+
