...
To use custom Accelerators, please refer to xref:../installation/canvas.adoc#custom-accelerators[Installation → {CANVAS} -> Configuring custom Accelerators for your organization]
