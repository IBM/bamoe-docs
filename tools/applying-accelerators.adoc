...
====
// how can you modify the accelerator.yaml file I assume it is not possible in the dialog and would be a manual update? Perhaps needs rewriting to give context.
