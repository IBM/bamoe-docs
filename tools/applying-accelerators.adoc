...
{CANVAS} provides a set of useful default Accelerators -- `Quarkus (DMN)` and `Quarkus (Full)`. For other ways to start a _Business Service_ project, see xref:../getting-started/project-setup.adoc[Getting started → Initial _Business Service_ project setup]
