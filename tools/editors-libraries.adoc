...
This functionality is available only in version {VERSION_911}.
The editors used in both {CANVAS} and {DEV_TOOLS} are also available as standalone Javascript libraries that can be embedded into any frontend web application.
