...
This section summarizes the tested and supported configurations available for {PRODUCT_SHORT} {VERSION_92X}. Support is available for any issues you identify while using the product in production or development, physical or virtual environments, and depending on your subscription agreement. For any supplementary details, in particular for patch releases, you can see the https://www.ibm.com/software/reports/compatibility/clarity-reports/report/html/softwareReqsForProduct?deliverableId=BF430D4BABE04E40B2F9A5AF8333591A&osPlatforms=spcrAllValues&duComponentIds=spcrAllValues&mandatoryCapIds=spcrAllValues&optionalCapIds=spcrAllValues[IBM Support site link].
...
== {PRODUCT_SHORT} {VERSION_921} 
This section summarizes the tested and supported configurations available for {PRODUCT_SHORT} {VERSION_921}.
...
*GraalVM support is limited to native-image for native compilation. For information on native compilation support, see xref:../release-notes/known-limitations.adoc[Known limitations]
...
|Red Hat Enterprise Linux 9.5 (RHEL) / x86_64 | OpenShift Container Platform 4.17 
...
|Microsoft Windows Server 2022 / x86_64 | OpenShift Container Platform 4.17
...
== {PRODUCT_SHORT} {VERSION_920} 
This section summarizes the tested and supported configurations available for {PRODUCT_SHORT} {VERSION_920}.
