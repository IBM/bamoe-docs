...
The IBM Support site provides the details of prerequisites and the operating systems, containers, and software that {PRODUCT_SHORT} {VERSION_930} and {VERSION} support, see:

* https://www.ibm.com/software/reports/compatibility/clarity-reports/report/html/softwareReqsForProduct?deliverableId=A426350AE92E4DF3A2C5D62073363C70&osPlatforms=spcrAllValues&duComponentIds=spcrAllValues&mandatoryCapIds=spcrAllValues&optionalCapIds=spcrAllValues[Detailed System Requirements]
