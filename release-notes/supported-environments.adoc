...
The IBM Support site provides the details of prerequisites and the operating systems, containers, and software that {PRODUCT_SHORT} {VERSION_RM} supports:

https://www.ibm.com/software/reports/compatibility/clarity-reports/report/html/softwareReqsForProduct?deliverableId=4DACEB52F7444E53AE5CC48EC232AB17&osPlatforms=spcrAllValues&duComponentIds=spcrAllValues&mandatoryCapIds=spcrAllValues&optionalCapIds=spcrAllValues[Detailed System Requirements]
////
