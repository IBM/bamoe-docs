...
.
|* The version 9.2.0 provides no native compilation support for DMN, BPMN and DRL projects. You might encounter build-time failures if you attempt to use native compilation with these features. 
