...
A number of features and components have been deprecated in {PRODUCT_SHORT} and will be removed in a future release. See table below for the feature and version it was deprecated or removed in:

|===
| *Deprecated Feature* | *Replacement* | *Version*
| Support for IBM Semeru Runtime Open Edition 17
...
| Test Scenario Editor (classic) https://www.ibm.com/docs/en/ibamoe/9.1.x?topic=models-authoring-test-scenarios[Learn more...]
| Test Scenario Editor xref:../editing/authoring-scesim.adoc[Learn more...]
|{VERSION_930}

a| Jobs Service addons:
...
| Embedded Jobs service addons xref:../workflow/overview.adoc[Learn more...]
|{VERSION_930}
|===
