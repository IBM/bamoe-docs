...
=== Workflow monitoring 
Track and analyze the activity within your _Business Services_ using {PRODUCT_SHORT}'s monitoring capabilities. With built-in support for Prometheus, you can collect metrics and visualize them using tools like Grafana. xref:../workflows/monitoring.adoc[Learn more...].
