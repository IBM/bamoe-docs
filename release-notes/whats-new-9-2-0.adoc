...
Some highlights of the new User Tasks subsystem include SLA tracking, Customizable user groups, and customizable automatic User Task assignment. xref:../workflow/designing-workflow.adoc#user-tasks[Learn more...]
...
The scripts can be found in the product deliverables and support both the PostgreSQL and Microsoft SQL databases. xref:../workflow/deploying-process-services.adoc#jdbc-persistence[Learn more...]
