...
The scripts are available in the product deliverables and support both the PostgreSQL and Microsoft SQL datbases. [Learn more...]

=== Capable User Task subsystem for human driven Workflows
