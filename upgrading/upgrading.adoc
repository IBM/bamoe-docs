...
If you are in version {VERSION_90X} and want to upgrade to the latest version (9.2.1), follow this link to upgrade to {VERSION_91X} first https://ibmdocs-test.dcs.ibm.com/docs/en/ibamoe/9.1.x?topic=upgrading[Upgrading from 9.0.x] and then follow the link to upgrade to 9.2.x: https://ibmdocs-test.dcs.ibm.com/docs/en/ibamoe/9.2.x?topic=upgrading-from-91x[Upgrading from 9.1.x].
