...
If you are upgrading from version {VERSION_90X}, you must follow the steps documented in this section to upgrade to the intermediate version {VERSION_911} before upgrading to the most recent version (9.2.1, see https://ibmdocs-test.dcs.ibm.com/docs/en/ibamoe/9.2.x?topic=upgrading-from-91x[{PRODUCT_SHORT} 9.2.x → Upgrading from 9.1.x]). 
