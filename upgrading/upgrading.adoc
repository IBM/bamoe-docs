...
If you are in version {VERSION_90X} and want to upgrade to the latest version (9.2.1), upgrade first to version {VERSION_91X} and then follow the link, https://ibmdocs-test.dcs.ibm.com/docs/en/ibamoe/9.2.x?topic=upgrading-from-91x[Upgrading from 9.1.x] to upgrade to version 9.2.x.
