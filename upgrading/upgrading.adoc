...
You can upgrade your existing business automation applications and platforms to the most recent version of {PRODUCT_LONG}. If you are upgrading from version {VERSION_90X}, you must follow the steps documented in this section to upgrade to the intermediate version {VERSION_911}, and then to version 9.2.1, https://ibmdocs-test.dcs.ibm.com/docs/en/ibamoe/9.2.x?topic=upgrading-from-91x[Upgrading from 9.1.x]. Depending on the complexity of your installation, you might want IBM(R) Services to participate in your project. If so, contact your IBM service representative.
