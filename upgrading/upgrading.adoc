...
Start by downloading the product archives from either {PRODUCT_FIX_CENTRAL_PAGE_LINK}[IBM Fix Central] which requires an active support subscription to {PRODUCT}, or via the {DEV_PROGRAM_PAGE_LINK}[IBM Business Automation Manager Open Editions Developer Program]. For more information, see https://www.ibm.com/support/pages/node/7151078[BAMOE 9.1 Download Document].
...
The following tools are required to upgrade your {PRODUCT_SHORT} version {VERSION}:
...
Now that you have the Maven configured, you can create a new Maven project to upgrade your existing business automation assets to the new {PRODUCT_SHORT} version {VERSION}.
