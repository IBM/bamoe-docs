...
You can upgrade your existing business automation applications and platforms to the most recent version of {PRODUCT_LONG}. If you are upgrading from version {VERSION_90X}, you must follow the steps to upgrade to the intermediate version {VERSION_911}, and then to version 9.2.1, as documented. Depending on the complexity of your installation, you might want IBM(R) Services to participate in your project. If so, contact your IBM service representative.

If you are in version {VERSION_90X} and want to upgrade to the latest version (9.2.1), follow this link, https://ibmdocs-test.dcs.ibm.com/docs/en/ibamoe/9.1.x?topic=upgrading[Upgrading from 9.0.x] to upgrade to version {VERSION_91X} first  and then follow the link, https://ibmdocs-test.dcs.ibm.com/docs/en/ibamoe/9.2.x?topic=upgrading-from-91x[Upgrading from 9.1.x] to upgrade to version 9.2.x.
