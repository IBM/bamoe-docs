...
Automated update tools are specifically provided with minor versions of {PRODUCT} to facilitate updating certain components such as {CANVAS}, {VS_CODE_BUNDLE} and 
{FORM_GENERATION_TOOL}.
Other {PRODUCT} artifacts are released as new artifacts with each minor release and you must reinstall them to apply the update. See See https://ibmdocs-test.dcs.ibm.com/docs/en/ibamoe/9.1.x?topic=installing[Installing]
...
== Step 4b: Upgrading a {PRODUCT_SHORT} version {VERSION_90x} project
