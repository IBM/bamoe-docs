...
| bamoe-9.1.1-standalone-bpmn-and-dmn-editors-classic.tgz   
...
| bamoe-9.1.1-canvas-helm-chart.tgz
...
| bamoe-9.1.1-canvas-docker-compose.zip
...
| bamoe-9.1.1-cors-proxy-image.tar.gz
...
| bamoe-9.1.1-canvas-dev-deployment-upload-service.zip
...
| bamoe-9.1.1-canvas-dev-deployment-base-image.tar.gz
...
| bamoe-9.1.1-canvas-dev-deployment-quarkus-blank-app-image.tar.gz
...
| bamoe-9.1.1-canvas-dev-deployment-dmn-form-webapp-image.tar.gz
...
You should consider updating certain components such as {CANVAS}, {VS_CODE_BUNDLE} and 
{FORM_GENERATION_TOOL}.

To update {CANVAS}-::
The new containers are the drop-in replacements for the existing. To install new version of canvas, see https://ibmdocs-test.dcs.ibm.com/docs/en/ibamoe/9.1.x?topic=installing[Installing].

In parallel, refer https://docs.openshift.com/container-platform/4.14/applications/deployments/route-based-deployment-strategies.html#deployments-blue-green_route-based-deployment-strategies[blue/green deployment strategies].

To know more on projects, see step 4a.

To update {VS_CODE_BUNDLE}-::

You can deploy the latest version of {PRODUCT} as a new installation or as an update from one of the previous releases.

You can use the same automated update tool to apply release upgrades. Typically, the release upgrades will include enhancements, security updates, and bug fixes.
...
To know more about {VS_CODE_BUNDLE}, see xref:../tools/developer-tools-for-vscode.adoc[Developer Tools for VS Code].

To update {FORM_GENERATION_TOOL}-::
This is required for workflow execution. To know more about {FORM_GENERATION_TOOL}, see xref:../tools/form-generation-tool.adoc[Form generation tool].
...
Automated update runtime is specifically provided with minor versions of {PRODUCT} to facilitate updating certain components such as Decision and Rules Engine and Process Engine.

Other {PRODUCT} artifacts are released as new artifacts with each minor release and you must reinstall them to apply the update. See https://ibmdocs-test.dcs.ibm.com/docs/en/ibamoe/9.1.x?topic=installing[Installing].


You can deploy the latest version of {PRODUCT} as a new installation.

You can use the same automated update runtime to apply minor release upgrades. The minor release upgrades will include enhancements, security updates, and bug fixes.

[NOTE]
====
Only updates are included in the {PRODUCT} update runtime.
====
