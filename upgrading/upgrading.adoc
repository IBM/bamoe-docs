...
Existing DMN files (any version) can be opened directly in the new DMN Editor. For more information, see xref:../editing/authoring-decisions.adoc[Authoring Decisions with DMN].
