...
If you have experienced some difficulties when trying to upgrade your project you can create a new _Business Service_ project project from scratch and import your existing business automation assets (Workflows, Decisions, Rules, and Decision Tables) to the new project.
...
If you are getting started with stateful Workflows, follow xref:../workflow/workflow-techpreview.adoc[Technology preview: Developing process services → Interacting with processes and tasks using Consoles] for information on installing `Management and Task console` for the first time in your production environment.

Once you have a new installation, you can follow the standard guidance on how to deploy a new version of your _Business Services_ (see xref:../runtime-services-modeling/services-build.adoc[Building Business Services executables] and xref:../runtime-services-modeling/services-deployment.adoc[Deploying Business Services]).
