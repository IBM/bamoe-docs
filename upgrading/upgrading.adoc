...
If you are using {VERSION_91X} technology preview for stateful Workflows, you will find instructions on what to do to migrate your stateful workflow projects in xref:#migrate-tech-preview[tthis section].
...
[#step-3a]
== Step 3a: Upgrade _Business Service_ projects on {PRODUCT_SHORT} versions {VERSION_90X} or {VERSION_91X}

Once your {PRODUCT_SHORT} development environment installation is upgraded, it is straightforward to upgrade your _Business Service_ project on {PRODUCT_SHORT} {VERSION_91x} to {PRODUCT_SHORT} version {VERSION}.
...
[WARNING]
====
If you come across some difficulties when trying to upgrade your existing _Business Service_ projects we recommend creating a new project to xref:../upgrading/upgrading.adoc#step-3b[Step 3b: Upgrade _Business Service_ projects on {PRODUCT_SHORT} versions {VERSION_90X} or {VERSION_91X}].
====
...
See xref:../release-notes/version-mapping.adoc[version mapping].
...
Once you have a new installation for {MANAGEMENT_CONSOLE} version {VERSION}, you can follow the standard guidance on how to deploy a new version of your _Business Services_ (see xref:../runtime-services-modeling/services-deployment.adoc[Building _Business Services_ executables] and xref:../runtime-services-modeling/services-deployment.adoc[Deploying _Business Services_]).
