...
Ensure that you have checked the 'Auto Update' checkbox when you are on IBM BAMOE Developer Tools. This will take care of your updates automatically.

To know how to set the 'Auto Update', go to Visual Studio Code, click Extensions and then select the IBM BAMOE Developer Tools. You will see a checkbox 'Auto Update' on the page. Click it to set. To know more about {VS_CODE_BUNDLE}, see xref:../tools/developer-tools-for-vscode.adoc[Developer Tools for VS Code].
