...
== Step 3a: Creating a new project from scratch
...
+
Currently, the Quarkus Dev Services is not fully supported, meaning that it should be disabled.
...
== Step 3b: Upgrading a {PRODUCT_SHORT} version {VERSION_90x} project
...
=== Step 5: Compile, Build, Test, Deploy
