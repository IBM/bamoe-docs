...
[NOTE]
====
In the displayed table, you must replace VERSION with the version of IBM Business Automation Manager you are upgrading to, such as 9.1.1.
...
You need to update your business service and management and task console. 
...
To update your management and task console installation, see xref:../workflow/consoles.adoc[consoles].
