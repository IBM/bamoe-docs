...
Refer to xref:..\reference-guide/drl.adoc[Reference → Drools Rule Language (DRL)]
for information on upgrading to the latest version of Drools Rule Language (DRL).
====
