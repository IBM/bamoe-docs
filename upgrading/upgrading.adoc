...
[WARNING]
====
If you come across some difficulties when trying to upgrade your existing _Business Service_ projects we recommend creating a new project to xref:../upgrading/upgrading.adoc#step-3b[Step 3b: Upgrade Business Service projects on {PRODUCT_SHORT} versions {VERSION_90X} or {VERSION_91X}].
====
