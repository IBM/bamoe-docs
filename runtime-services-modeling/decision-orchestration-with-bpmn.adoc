...
[id="con-serverless-workflow-in-kogito"]
...
.Serverless Workflow orchestration in {PRODUCT}
image::serverless-workflow-kogito.png[Image of Serverless Workflow orchestration in Kogito]
...
[id="proc-serverless-workflow-definitions"]
