...
In VS Code (recommended), you can add the {DEV_TOOLS_VSCODE_MARKETPLACE_LINK}[*{DEV_TOOLS}*] to design the decision requirements diagram (DRD), boxed expression, and data types with the {PRODUCT} DMN Editor.
