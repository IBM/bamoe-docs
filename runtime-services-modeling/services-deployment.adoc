...
Make sure you have KIE Flyway disabled to guarantee your _Business Service_ containing stateful Workflows subsystems configured with persistence won't apply changes to your database schema in your production environment.
