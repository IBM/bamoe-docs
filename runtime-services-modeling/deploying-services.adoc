...
This command generates a `sample-kogito` Maven project and import the {PRODUCT} extension for all required dependencies and configurations to prepare your application for business automation.
--
. Open or import the project in your {CANVAS} environment or VSCode IDE to view the contents.
