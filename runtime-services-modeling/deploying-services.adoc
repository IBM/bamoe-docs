...
[id="con-kogito-quarkus-springboot"]
...
[id="proc-kogito-creating-project-spring-boot"]
.On Spring Boot
[source,subs="attributes+"]
----
...
[id="proc-customizing-spring-boot-project-creation"]
...
[id="con-kogito-spring-boot-starters"]
...
When you create a project, the `pom.xml` file contains all the necessary starters. You can also include a new starter if required.

[id="ref-kogito-spring-boot-starter"]
