...
* *{PRODUCT_SHORT} VSCode extension*: Enables you to view and design BPMN and DMN models in Visual Studio Code (VSCode). See the xref:../tools/developer-tools-for-vscode.adoc[VSCode extension] chapter for further details.
