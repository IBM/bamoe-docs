= DRL Rules Execution in Embedded Java mode
...
// TODO is 9.1.0.rc3-ibm-0001 the final to use?
[source,xml]
----
...
Most of the mentioned concepts can be seen in a complete example https://github.com/bamoe/bamoe-docs-source-code-examples/pull/5[here].
