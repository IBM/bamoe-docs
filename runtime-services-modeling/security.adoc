...
The list of properties required to setup your project may change based on your security needs, Identity and Access Management Solution. Following is an example of the configuration.
...
The following table describes in detail the properties proposed in the example, but it is only a subset of all available properties available https://quarkus.io/guides/security-oidc-configuration-properties-reference[here].
