...
You can find a detailed explanation and guide https://quarkus.io/version/3.8/guides/security-authorize-web-endpoints-reference[in the link shared earlier] to define your permissions and the consequence on the required properties to add in your `application.property` file.
