...
.Quarkus dependency for Elastic
[source,xml,subs="attributes+"]
----
<dependency>
  <groupId>org.kie</groupId>
...
The persistence add-on provides persistence capability in your _Business Service_ project.
...
To configure process management REST capabilities for your _Business Services_, you can add the process management add-on as a dependency in the `pom.xml` file of your _Business Service_ project:
...
To configure process SVG REST capabilities for your _Business Services_, you can add the process SVG add-on as a dependency in the `pom.xml` file of your _Business Service_ project:
