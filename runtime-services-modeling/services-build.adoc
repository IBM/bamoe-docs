...
[NOTE]
====
{PRODUCT_SHORT} version {VERSION} is tested against Quarkus 15 (LTS), JDK 17, and GraalVM 21 for JDK 17. For more details see xref:../release-notes/supported-environments.html[Supported environments].
====
+
