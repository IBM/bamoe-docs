...
For each consumed event, the add-on generates a https://knative.dev/docs/getting-started/getting-started-eventing/[Knative Eventing Trigger] as shown in the following example:
