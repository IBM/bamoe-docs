...
You can find the DMN source file for this decision model on https://raw.githubusercontent.com/apache/incubator-kie-drools/8.39.0.Final/kie-dmn/kie-dmn-core/src/test/resources/org/kie/dmn/core/0019-flight-rebooking.dmn[**github**] .
