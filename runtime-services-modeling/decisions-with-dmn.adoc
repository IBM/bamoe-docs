...
[id="con-dmn-iterator-expressions"]
==== Boxed iterator expressions
...
The example below is an alternative way of producing a list similar to the <<approved-credit-score-agency-list-example, Boxed list expression example>>.

.Iterator expression of Approved credit score agencies
image::runtime-services-modeling/dmn-iterator-expression.png[]

NOTE: This feature was introduced as part of {PRODUCT} 9.1 and DMN 1.5 releases.
...
.Every expression of Will Flight Together decision
...
.Some expression of Will Not Flight Together decision
...
The example below is an alternative way of defining logic similar to the <<flight-capacity-example>> example.
