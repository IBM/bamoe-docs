...
You will be connected to a  _Business Service_ by the following instruction:
...
image::runtime-services-modeling/mgmt-console-overview.gif[Image of {MANAGEMENT_CONSOLE} overview]
