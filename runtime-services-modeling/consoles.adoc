...
{MANAGEMENT_CONSOLE} is a web application for viewing the state of all available {PRODUCT_SHORT} services and managing and interacting with process instances:
