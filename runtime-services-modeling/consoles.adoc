...
[NOTE]
For information on how to secure your {PRODUCT_SHORT} service and expose the Indentity Provider URL to the {MANAGEMENT_CONSOLE} check xref:./security.adoc[Securing Business Service API endpoints]
