...
ifdef::DM,PAM[]
:MAVEN_ARTIFACT_VERSION: {COMMUNITY_VERSION_FINAL}-redhat-0017
...
:ASSEMBLIES_XREF: xref:../assemblies
:ASSEMBLIES_XREF_DEV: xref:assemblies
:URL_RELEASE_NOTES: xref:../release-notes.html
:URL_DECISION_ARCHITECTURE: xref:../designing_architecture.html
:URL_INSTALLING_AND_CONFIGURING: {ASSEMBLIES_XREF}
:URL_GETTING_STARTED: {ASSEMBLIES_XREF}
:URL_GETTING_STARTED_KOGITO_MICROSERVICES: {ASSEMBLIES_XREF}
:URL_DEVELOPING_DECISION_SERVICES: {ASSEMBLIES_XREF_DEV}
:URL_DEVELOPING_PROCESS_SERVICES: {ASSEMBLIES_XREF}
:URL_DEPLOYING_AND_MANAGING_SERVICES: {ASSEMBLIES_XREF}
:URL_DEPLOYING_ON_OPENSHIFT: {ASSEMBLIES_XREF}
:URL_MANAGING_SETTINGS: {ASSEMBLIES_XREF}
:URL_INTEGRATING: {ASSEMBLIES_XREF}
