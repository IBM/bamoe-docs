...
* https://www.ibm.com/docs/en/ibamoe/8.0.x?topic=settings-managing-monitoring-kie-server[BAMOE version 8 session persistence entities]
* xref:../reference-guide/stateful-workflows-database-tables.adoc[BAMOE version 9.3 database tables]
