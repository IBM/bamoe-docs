...
. Upgrade the project structure as outlined in xref:05-02-upgrading-client-server-projects.adoc[Upgrading Client-Server Projects]
. If required, upgrade individual workflow assets as described in xref:05-04-upgrading-individual-assets.adoc[Upgrading Individual Assets]
...
NOTE: There is no automated tooling provided as part of BAMOE 9 distribution that takes care of inflight process instances upgrade from version 8 to 9.
