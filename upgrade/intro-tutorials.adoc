...
* Fourteen tutorial folders, each following the same internal structure:
...
| xref:{BAMOE_DOCS_TUTORIALS_DOCS_LINK}/tutorial-01-evaluation-process/README.md[`tutorial-01-evaluation-process`]
...
| xref:{BAMOE_DOCS_TUTORIALS_DOCS_LINK}/tutorial-02-mortgage-application/README.md[`tutorial-02-mortgage-application`]
...
| xref:{BAMOE_DOCS_TUTORIALS_DOCS_LINK}/tutorial-03-traffic-violation/README.md[`tutorial-03-traffic-violation`]
...
| xref:{BAMOE_DOCS_TUTORIALS_DOCS_LINK}/tutorial-04-upgrade-guide-scenarios/README.md[`tutorial-04-upgrade-guide-scenarios`]
...
| xref:{BAMOE_DOCS_TUTORIALS_DOCS_LINK}/tutorial-05-event-listeners/README.md[`tutorial-05-event-listeners`]
...
| xref:{BAMOE_DOCS_TUTORIALS_DOCS_LINK}/tutorial-06-process-variable-persistence/README.md[`tutorial-06-process-variable-persistence`]
...
| xref:{BAMOE_DOCS_TUTORIALS_DOCS_LINK}/tutorial-07-human-task-escalation/readme.md[`tutorial-07-human-task-escalation`]
| Migrating task deadlines, escalation rules, SLA triggers, and dynamic assignment strategies.

|
| **Tutorial 8: Email Notifications**
| xref:{BAMOE_DOCS_TUTORIALS_DOCS_LINK}/tutorial-08-email-notifications/README.md[`tutorial-08-email-notifications`]
...
| xref:{BAMOE_DOCS_TUTORIALS_DOCS_LINK}/tutorial-09-complex-data-models/README.md[`tutorial-09-complex-data-models`]
...
| xref:{BAMOE_DOCS_TUTORIALS_DOCS_LINK}/tutorial-10-multi-module/README.md[`tutorial-10-multi-module-projects`]
...
| xref:{BAMOE_DOCS_TUTORIALS_DOCS_LINK}/tutorial-12-database-integration/README.md[`tutorial-12-database-async-processing`]
...
| xref:{BAMOE_DOCS_TUTORIALS_DOCS_LINK}/tutorial-11-usergroupcallback-security/README.md[`tutorial-11-external-services-security`]
...
| xref:{BAMOE_DOCS_TUTORIALS_DOCS_LINK}/tutorial-13-common-issues/README.md[`tutorial-13-common-migration-issues`]
...
| **Case Management**
| **Tutorial 14: Case Management IT Orders**
| xref:{BAMOE_DOCS_TUTORIALS_DOCS_LINK}/tutorial-14-case-management-it-orders/README.md[`tutorial-14-case-management-orders`]
| Migrating v8 ad-hoc case management to v9 and handling conditional milestone activation changes.
...
- **Development environment** set up using either BAMOE Canvas (web-based) or Visual Studio Code with the BAMOE Developer Tools extension.
