...
For detailed guidance on securing Business Service API endpoints, refer to the official https://www.ibm.com/docs/en/ibamoe/9.2.x?topic=services-securing-business-service-api-endpoints[Securing Business Service API endpoints].
