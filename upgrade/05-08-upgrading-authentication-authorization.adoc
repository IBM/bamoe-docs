...
For detailed guidance on securing Business Service API endpoints, refer to the official xref:../building-deploying/security.adoc[Securing Business Service API endpoints].
