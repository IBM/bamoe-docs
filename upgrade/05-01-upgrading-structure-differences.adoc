...
| Configurations and activators are in Java and `application.properties` file. Read https://ibm.com/docs/en/ibamoe/9.2.x?topic=developing-stateful-workflows[Developing stateful Workflows] section for more information.
