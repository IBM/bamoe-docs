...
== Client-server and standalone comparison on BAMOE 8 and BAMOE 9.3
...
| *Spring Boot Version*
| Spring Boot 2.5.12
| Spring Boot 3.4.9 (for Decisions and Rules)
...
| BAMOE Developer Tools for VS Code provides a command to generate forms, and BAMOE Quarkus Dev UI provides a form editor. See xref:../tools/form-generation.adoc[Form code generation for User Tasks][Form code generation functionality] section.
