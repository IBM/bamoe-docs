...
| BAMOE supports custom persistence via Quarkus or Spring Boot configuration mechanisms. Read more on https://www.ibm.com/docs/en/ibamoe/9.2.x?topic=workflows-configuring-persistence-stateful[Configuring persistence for stateful Workflows]
