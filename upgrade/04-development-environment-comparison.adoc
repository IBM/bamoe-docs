...
The BAMOE Developer Tools for VS Code offer a full-featured environment for developers to author and manage BPMN, DMN, and SCESIM assets. The extension also supports generating user task forms and integrates with Maven for validation, testing, and packaging. This setup gives developers full control over the development lifecycle using familiar IDE workflows.
