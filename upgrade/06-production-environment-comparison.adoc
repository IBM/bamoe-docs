...
| BAMOE v9 Business Service projects can be packaged as a Container image, JAR file or Native Executable. They can also be packaged as KJAR with pom.xml and kmodule.xml when using https://www.ibm.com/docs/en/ibamoe/9.2.x?topic=scenarios-executing-decisions-in-embedded-java-mode#_complete_example[decision] and https://www.ibm.com/docs/en/ibamoe/9.2.x?topic=scenarios-executing-rules-in-embedded-java-mode[rules] in Java embedded mode
