...
| Swagger UI documentation for Domain and Management APIs are available at `+http://SERVER:PORT/q/swagger-ui+`. See Using the https://www.ibm.com/docs/en/ibamoe/9.3.x?topic=workflows-running-locally-bamoe-quarkus-dev-ui#_using_the_swagger_ui[Swagger UI].
