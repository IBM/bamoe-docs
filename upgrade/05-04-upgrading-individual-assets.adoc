...
In BAMOE v8, the development environment provided tooling for both DRL-based and DMN-based Test Scenarios. In contrast, BAMOE v9 offers tooling support exclusively for DMN-based Test Scenarios. This limitation is currently documented as a xref:10-known-limitations.adoc[known limitation].
