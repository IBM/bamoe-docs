...
While this approach does not replicate all features of CMMN, it provides a practical alternative for many use cases. For detailed guidance on migrating Case Management projects to Flexible Processes, see the xref:05-10-upgrading-case-mgmt-project.adoc[Upgrading Case Management Projects section].
