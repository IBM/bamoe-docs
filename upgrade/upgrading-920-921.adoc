...
This section describes the steps you will need to take to upgrade _Business Services_ projets developed with {PRODUCT_SHORT} versions {VERSION_920}. 

NOTE: For information on upgraded from {VERSION_91x} see xref:upgrading-91x-92x.adoc[Upgrading from 9.1.x]. For information on upgraded from 8.0.x see xref:upgrading-80x-921.adoc[Upgrading from 8.0.x]
