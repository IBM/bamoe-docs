...
=== Workflows
* xref:../workflow/process-api.adoc[Process API]
* xref:../workflow/data-index-graphql-api.adoc[Data-Index GraphQL API]
* xref:../workflow/data-audit-api.adoc[Data-Audit API]
* xref:../managing-monitoring/management-apis.adoc[Process Management API]
* xref:../workflow/user-tasks.adoc[User Tasks API]

=== Decisions
* xref:../editing/decision-api.adoc[Decision API]
...
{MANAGEMENT_CONSOLE} connects to live _Business Services_ and allows you to manage _Business Services_ containing Workflows via a web-based UI. {MANAGEMENT_CONSOLE} is intended for admin usage. See more at xref:../managing-monitoring/consoles.adoc[Managing live Workflows using BAMOE Management Console].