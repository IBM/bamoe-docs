...
* xref:assemblies/assembly-openshift-operator.adoc[_{DEPLOYING_OPENSHIFT_OPERATOR}_]
...
xref:assemblies/assembly-managing-and-monitoring-execution-server.html[_{MANAGING_KIE_SERVER}_]
endif::[]
