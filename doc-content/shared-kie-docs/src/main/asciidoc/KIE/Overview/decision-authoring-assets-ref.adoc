...
a|
ifdef::DM,PAM[]
xref:assembly-guided-rule-templates.html[_{GUIDED_RULE_TEMPLATES}_]
endif::[]
ifdef::DROOLS,JBPM,OP[]
...
a|
ifdef::DM,PAM[]
xref:assembly-drl-rules.html[_{DRL_RULES}_]
endif::[]
ifdef::DROOLS,JBPM,OP[]
...
a|
ifdef::DM,PAM[]
xref:assembly-pmml-models.html[_{PMML_MODELS}_]
endif::[]
ifdef::DROOLS,JBPM,OP[]
