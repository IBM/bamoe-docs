...
a|
ifdef::DM,PAM[]
xref:assemblies/assembly-dmn-models.html[_{DMN_MODELS}_]
endif::[]
...
a|
ifdef::DM,PAM[]
xref:assemblies/assembly-guided-decision-tables.html[_{GUIDED_DECISION_TABLES}_]
endif::[]
ifdef::DROOLS,JBPM,OP[]
...
a|
ifdef::DM,PAM[]
xref:assemblies/assembly-decision-tables.html[_{SPREADSHEET_DECISION_TABLES}_]
endif::[]
ifdef::DROOLS,JBPM,OP[]
...
a|
ifdef::DM,PAM[]
xref:assemblies/assembly-guided-rules.html[_{GUIDED_RULES}_]
endif::[]
ifdef::DROOLS,JBPM,OP[]
...
a|
ifdef::DM,PAM[]
xref:assemblies/assembly-guided-rule-templates.html[_{GUIDED_RULE_TEMPLATES}_]
endif::[]
ifdef::DROOLS,JBPM,OP[]
...
a|
ifdef::DM,PAM[]
xref:assemblies/assembly-drl-rules.html[_{DRL_RULES}_]
endif::[]
ifdef::DROOLS,JBPM,OP[]
