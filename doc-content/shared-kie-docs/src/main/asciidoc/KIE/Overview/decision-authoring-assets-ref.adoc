...
a|
ifdef::DM,PAM[]
{URL_DEVELOPING_DECISION_SERVICES}/assembly-guided-decision-tables.html[_{GUIDED_DECISION_TABLES}_]
endif::[]
ifdef::DROOLS,JBPM,OP[]
...
a|
ifdef::DM,PAM[]
{URL_DEVELOPING_DECISION_SERVICES}/assembly-guided-rules.html[_{GUIDED_RULES}_]
endif::[]
ifdef::DROOLS,JBPM,OP[]
...
a|
ifdef::DM,PAM[]
{URL_DEVELOPING_DECISION_SERVICES}/assembly-guided-rule-templates.html[_{GUIDED_RULE_TEMPLATES}_]
endif::[]
ifdef::DROOLS,JBPM,OP[]
...
a|
ifdef::DM,PAM[]
{URL_DEVELOPING_DECISION_SERVICES}/assembly-drl-rules.html[_{DRL_RULES}_]
endif::[]
ifdef::DROOLS,JBPM,OP[]
...
a|
ifdef::DM,PAM[]
{URL_DEVELOPING_DECISION_SERVICES}/assembly-pmml-models.html[_{PMML_MODELS}_]
endif::[]
ifdef::DROOLS,JBPM,OP[]
...
When you define business decisions, you can also consider using {KOGITO} for your cloud-native decision services. For more information about getting started with {KOGITO} microservices, see xref:./designing-architecture.html#decision-authoring-assets-ref_decision-management-architecture[_{GETTING_STARTED_KOGITO_MICROSERVICES}_].
