...
a|
ifdef::DM,PAM[]
xref:assemblies/assembly-drl-rules.html#assets-executing-proc_guided-rules["Executing rules" in _{DRL_RULES}_]
endif::[]
ifdef::DROOLS,JBPM,OP[]
...
ifdef::DM,PAM[]
xref:clustering-smartrouter-install-proc.html_clustering-runtime-standalone[_{INSTALLING_ON_EAP_CLUSTER}_].
endif::[]
ifdef::DROOLS,JBPM,OP[]
