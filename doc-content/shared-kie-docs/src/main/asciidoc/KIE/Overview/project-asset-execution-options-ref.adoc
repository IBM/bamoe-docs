...
|link:https://docs.drools.org/6.5.0.Final/kie-api-javadoc/[_KIE Public API_]
...
a|
ifdef::DM,PAM[]
xref:assemblies/assembly-drl-rules.html["Executing rules" in _{DRL_RULES}_]
endif::[]
ifdef::DROOLS,JBPM,OP[]
...
ifdef::DM,PAM[]
xref:assemblies/assembly-clustering-eap.html[_{INSTALLING_ON_EAP_CLUSTER}_].
endif::[]
ifdef::DROOLS,JBPM,OP[]
