...
The {KIE_SERVER} Process Queries REST API provides endpoints for querying process definitions and process instances in a KIE Server environment. These endpoints allow users to retrieve detailed information about processes, instances, variables, nodes, and related entities. All API requests require authentication and are designed to support flexible filtering, sorting, and pagination options. This documentation describes the available endpoints, request parameters, and example responses to help users integrate and manage business processes using the {KIE_SERVER} REST API.
...
== [POST] /server/queries/variables/processes

Retrieves process instances along with their variables.
...
[source]
----
http://localhost:8080/kie-server/services/rest/server/queries/variables/processes?page=0&pageSize=10&asc=true
----
...
----
{
  "attributes-query-params": [
    ...
    {
      "cond-column": "PROCESS_DEFINITION_ID",
      "cond-operator": "EQUALS_TO",
      "cond-values": [
        "TimerTest.HumanTaskTest"
      ]
    }
  ],
  "task-query-params": null,
  "process-query-params": null,
  "case-query-params": null,
  "pot-owners-query-param": null,
  "pot-owners": null
} 
----
  ...
  "process-instance-vars": [
    {
      ...
      "process-id": "TimerTest.HumanTaskTest",
      "process-name": "HumanTaskTest",
      "process-version": "1.0",
      "process-instance-state": 1,
      "container-id": "TimerTest_1.0.0-SNAPSHOT",
      "initiator": "rhpamadmin",
      "start-date": 1751890285658,
      "process-instance-desc": null,
      "correlation-key": "2",
      "parent-instance-id": null,
...
== [POST] /server/queries/variables/processes/tasks

Retrieves user tasks along with process variables.
...
[source]
----
http://localhost:8080/kie-server/services/rest/server/queries/variables/processes/tasks?page=0&pageSize=10&orderBy=task.id&asc=true
----
  ...
  "user-task-with-vars-instance": [
    {
      ...
      "name": "Task",
      "description": null,
      "actual-owner": "rhpamadmin",
      "correlation-key": "2",
      "potential-owners": [
        "rhpamadmin"
      ],
      "process-definition-id": "TimerTest.HumanTaskTest",
      "process-instance-id": 2,
      "task-instance-input-variables": null,
      "process-variables": {
        "initiator": "rhpamadmin"
      },
      "status": "Reserved"
