...
|Integer
|`0`
|The frequency used to check for pending jobs by the {PRODUCT_SHORT} engine executor, in seconds. If the value is 0, the check is run once during the startup of the executor.
