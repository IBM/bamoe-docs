...
For a list of query mappers that are included in {PRODUCT}, see the https://github.com/kiegroup/jbpm/tree/main/jbpm-services/jbpm-kie-services/src/main/java/org/jbpm/kie/services/impl/query/mapper[GitHub repository].
