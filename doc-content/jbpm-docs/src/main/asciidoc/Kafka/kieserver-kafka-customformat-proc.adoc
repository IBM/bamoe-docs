...
+
You can download the interface definitons from the https://github.com/kiegroup/droolsjbpm-integration/tree/main/kie-server-parent/kie-server-services/kie-server-services-kafka/src/main/java/org/kie/server/services/jbpm/kafka[GitHub repository].
+
