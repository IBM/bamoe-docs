...
You can see the definitions of these views in the https://github.com/kiegroup/jbpm/tree/main/jbpm-persistence/jbpm-persistence-api/src/main/java/org/jbpm/persistence/api/integration/model[GitHub repository].
...
The definitions of the transformer classes and the `ESRequest` class are available in the https://github.com/kiegroup/jbpm/tree/main/jbpm-event-emitters/jbpm-event-emitters-elasticsearch/src/main/java/org/jbpm/event/emitters/elasticsearch[GitHub repository].
