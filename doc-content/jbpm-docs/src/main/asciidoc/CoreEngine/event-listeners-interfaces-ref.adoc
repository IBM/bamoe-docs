...
For the definition of the event classes that the {PROCESS_ENGINE} passes to the methods, see the `org.kie.api.event.process` package in the https://docs.drools.org/6.5.0.Final/kie-api-javadoc/index.html[Java documentation].
...
For the definition of the event class that the {PROCESS_ENGINE} passes to the methods, see the `org.kie.api.task` package in the https://docs.drools.org/6.5.0.Final/kie-api-javadoc/index.html[Java documentation].
