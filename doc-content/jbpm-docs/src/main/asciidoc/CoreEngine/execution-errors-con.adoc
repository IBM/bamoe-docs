...
ifdef::PAM,DM[]
For information about developing work item handlers, see {URL_DEVELOPING_PROCESS_SERVICES}/custom-tasks-work-item-handler-project-customization-con-custom-tasks.html[_{CUSTOM_TASKS_AND_HANDLERS}_].
endif::PAM,DM[]
...
ifdef::PAM,DM[]
For information about using {CENTRAL} to view execution errors and to create jobs that acknowledge the errors automatically, see {URL_DEVELOPING_PROCESS_SERVICES}/execution-error-management-con.html_managing-and-monitoring-processes[_{MANAGING_PROCESSES}_].
endif::PAM,DM[]
