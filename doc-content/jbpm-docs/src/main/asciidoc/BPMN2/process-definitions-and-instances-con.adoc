...
For more information about process and task administration in {CENTRAL}, see {URL_DEVELOPING_PROCESS_SERVICES}/assembly-managing-and-monitoring-business-processes.html[_{MANAGING_PROCESSES}_].
endif::[]
endif::[]
