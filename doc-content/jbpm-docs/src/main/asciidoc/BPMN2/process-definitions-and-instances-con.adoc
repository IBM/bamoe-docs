...
For more information about process and task administration in {CENTRAL}, see xref:assembly-managing-and-monitoring-business-processes.html[_{MANAGING_PROCESSES}_].
endif::[]
endif::[]
