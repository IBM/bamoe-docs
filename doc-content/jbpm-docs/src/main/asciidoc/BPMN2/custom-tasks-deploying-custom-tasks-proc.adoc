...
ifdef::DM,PAM[]
For more information, see xref:assembly-managing-and-monitoring-business-processes.html[_{MANAGING_PROCESSES}_].
endif::[]
...
ifdef::DM,PAM[]
For more information, see xref:assembly-custom-tasks-and-work-item-handlers.html[_Managing custom tasks in {CENTRAL}_].
endif::[]
