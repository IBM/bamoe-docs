...
ifdef::DM,PAM[]
For more information, see {URL_DEVELOPING_PROCESS_SERVICES}/manage-service-tasks-proc.html_managing-and-monitoring-processes[_{MANAGING_PROCESSES}_].
endif::[]
...
ifdef::DM,PAM[]
For more information, see {URL_DEVELOPING_PROCESS_SERVICES}/manage-service-tasks-proc.html_managing-and-monitoring-processes[_Managing custom tasks in {CENTRAL}_].
endif::[]
