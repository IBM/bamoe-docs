...
. Login into business-central and create a project.
...
. Work Item Definitions can be provided as `.wid` files or through `@wid` annotation. These files can be placed in:
+

* The top-level global/ directory

* The src/main/resources/ directory, optionally within a Java package structure (For example, src/main/resources/com/ibm/)

For more information about `.wid` files, see xref:work-item-definitions[Work item definitions].
