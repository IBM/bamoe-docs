...
ifdef::DM,PAM[]
For more information about `KafkaPublishMessages` in a business process, see {URL_INTEGRATING}/assembly-integrating-amq-streams.html[_{INTEGRATING_AMQ_STREAMS}_].
endif::DM,PAM[]
