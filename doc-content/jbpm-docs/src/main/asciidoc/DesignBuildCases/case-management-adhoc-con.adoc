...
Dynamic tasks can be user or service activities, while ad hoc tasks can be any type of task. For more information about task types, see "BPMN2 tasks in process designer" in xref:assembly-designing-business-processes.html[_{DESIGNING_BUSINESS_PROCESSES}_].
