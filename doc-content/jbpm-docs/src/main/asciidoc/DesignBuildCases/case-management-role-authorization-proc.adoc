...
For information about how to start a new case instance using the Showcase application, see xref:assembly-showcase-application.html[_{SHOWCASE_APPLICATION_CASE_MANAGEMENT}_].
