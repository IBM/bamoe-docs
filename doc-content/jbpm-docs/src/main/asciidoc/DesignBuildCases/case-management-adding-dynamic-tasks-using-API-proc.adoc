...
.Prerequisites
* You are logged in to {CENTRAL} and a case instance has been started using the Showcase application. For more information about using Showcase, see xref:assembly-showcase-application.html[_{SHOWCASE_APPLICATION_CASE_MANAGEMENT}_].
