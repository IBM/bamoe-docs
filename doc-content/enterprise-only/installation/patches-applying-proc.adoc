...
* `{PRODUCT_INIT}-{PRODUCT_VERSION}-BC7`: Updates {CENTRAL} (`bamoe-business-central-eap7-deployable.war`)
* `{PRODUCT_INIT_TOP}-{PRODUCT_VERSION}-KS8`: Updates {KIE_SERVER} (`bamoe-kie-server-ee8.war`)
+
