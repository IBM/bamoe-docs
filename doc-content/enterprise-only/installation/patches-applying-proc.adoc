...
+
If you encounter errors or notice any missing {CENTRAL} data, you can use the {CENTRAL} migration tool on your `.niogit` directory to prepare project data and system configurations. For more information, see xref:../assemblies/assembly-redhat-to-bamoe#niogit_directory.html [Using migration tool to prepare Business Central `.niogit` directory for upgrade].
+
