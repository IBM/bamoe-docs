...
You can use the automated update tool to apply patch updates within the {PRODUCT} 8.0. For example, updating from version 8.0.x to 8.0.y ensures your system receives the latest security updates and bug fixes.
