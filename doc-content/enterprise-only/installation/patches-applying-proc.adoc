...
. In your command terminal, copy the `.niogit` directory from your Business Central backup directory to the bin folder of your new installation.
+
...
. From the latest installation bin directory, delete the `.index` directory. You must delete this folder because latest version comes with certain updates that are not compatible with the old version. The bin directory will be re-indexed after the migration. 
