...
. Update {DATAGRID} to the latest version. For more information, see {DATAGRID} https://docs.redhat.com/en/documentation/red_hat_data_grid/7.3/html-single/red_hat_data_grid_user_guide/index[_{DATAGRID} User Guide_].
