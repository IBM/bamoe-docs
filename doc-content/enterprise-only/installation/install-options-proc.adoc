...
[NOTE]
====
* For information about installing {KIE_SERVER} on {WEBSPHERE}, see xref:assembly-installing-kie-server-on-was.html[_{INSTALLING_KIE_ON_WAS}_].
* For information about installing {KIE_SERVER} on {WEBLOGIC}, see xref:assembly-installing-kie-server-on-wls.html[_{INSTALLING_KIE_ON_WLS}_].
====
