...
.. Add {CENTRAL} administration users as described in xref:assembly-install-on-eap.html[_{INSTALLING_ON_EAP}_].
...
For more information about installing {CENTRAL}, see  xref:assembly-install-on-eap.html[_{INSTALLING_ON_EAP}_].
