...
For more information about exporting Dashbuilder data, see the "Exporting and importing Dashbuilder data" section in the xref:assembly-configuring-central.html[_{CONFIGURING_CENTRAL}_] guide.
