...
For instructions about using the PIM service, see xref:assemblies/assembly-managing-and-monitoring-business-processes.adoc[Process Instance Migration] in _{MANAGING_PROCESSES}_.
