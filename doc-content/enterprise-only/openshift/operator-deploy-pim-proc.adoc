...
For instructions about using the PIM service, see {URL_DEVELOPING_PROCESS_SERVICES}/process-instance-migration-con.html[Process Instance Migration] in _{MANAGING_PROCESSES}_.
