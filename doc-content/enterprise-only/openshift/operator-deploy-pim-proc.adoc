...
For instructions about using the PIM service, see {URL_DEVELOPING_PROCESS_SERVICES}/assembly-managing-and-monitoring-business-processes.adoc[Process Instance Migration] in _{MANAGING_PROCESSES}_.
