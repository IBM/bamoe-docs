...
. Download sample files from the https://github.com/jboss-container-images/rhpam-7-openshift-image/tree/main/quickstarts/post-configure-example[GitHub repository].
