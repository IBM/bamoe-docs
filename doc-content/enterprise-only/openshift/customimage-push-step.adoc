...
[source]
----
podman push registry.example.com/custom/{PRODUCT_INIT}-kieserver-rhel9:{ENTERPRISE_VERSION_LONG} docker://registry.example.com/custom/{PRODUCT_INIT}-{componentimage}-rhel8:{ENTERPRISE_VERSION_LONG}
----
