...
NOTE: If you have not created a project, you can either add a project, use a sample project, or import an existing project. For more information, see xref:assembly-managing-projects.html[_{MANAGING_PROJECTS}_].
