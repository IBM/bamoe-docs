...
Test the *Are they old enough* scenario using the data that you specified when you created the *Underage* guided rule. For information about testing decision services, see xref:assembly-test-scenarios.html[_{TESTING_DECISION_SERVICE}_].
