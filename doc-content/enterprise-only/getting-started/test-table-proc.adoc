...
Test the *Pricing low end* scenario using the data that is specified in the *Pricing loans* decision table as shown in <<_creating_decision_tables>>. For information about testing decision services, see xref:assembly-test-scenarios.html[_{TESTING_DECISION_SERVICE}_].
