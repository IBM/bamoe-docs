...
* If projects fail to deploy to {KIE_SERVER}, review your {KIE_SERVER} installation and configuration. For more information, see xref:assembly-planning.html[_{PLANNING_INSTALL}_].
endif::[]
ifeval::["{context}" == "exec-server"]
* If projects fail to deploy to {KIE_SERVER}, review your {KIE_SERVER} installation and configuration. For installation information, see xref:assembly-planning.html[_{PLANNING_INSTALL}_]. For configuration information, see xref:migration-configure-kie-server-proc[].
endif::[]
