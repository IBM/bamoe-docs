...
* For more information about persistence, see the "_Persisting process variables in a separate database schema in IBM Business Automation Manager_" section in https://www.ibm.com/docs/en/ibamoe/8.0.x?topic=settings-managing-monitoring-kie-server[Managing and monitoring KIE Server].
