...
* *Logs*: Displays process instance logs for the end users. For more information, see xref:assembly-interacting-with-processes.html[_{INTERACTING_PROCESSES_TASKS}_].
...
ifdef::PAM[]
For information on user credentials and conditions to be met to access {KIE_SERVER} runtime data, see xref:assembly-planning.html[_{PLANNING_INSTALL}_].
endif::PAM[]
