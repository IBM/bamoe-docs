...
* *Logs*: Displays process instance logs for the end users. For more information, see  {URL_DEVELOPING_PROCESS_SERVICES}/interacting-with-processes-viewing-process-instance-history-log-proc.html_interacting-with-processes[_{INTERACTING_PROCESSES_TASKS}_].
