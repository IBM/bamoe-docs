...
.Prerequisites
* an {PRODUCT} installation on {EAP_LONG} {EAP_VERSION} is available. For installation instructions, see xref:assembly-install-on-eap.html[_{INSTALLING_ON_EAP}_].
