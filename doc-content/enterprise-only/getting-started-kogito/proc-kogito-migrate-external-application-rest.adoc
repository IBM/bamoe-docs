...
+
For more information about REST endpoints for specific DMN models, see {URL_DEVELOPING_DECISION_SERVICES}/ref-rest-api-dmn-endpoints.html_dmn-models[_REST endpoints for specific DMN models_].
