...
+
For more information about REST endpoints for specific DMN models, see xref:assemblies/assembly-dmn-models.html[_REST endpoints for specific DMN models_].
