...
* The *KIE Business Automation Bundle* VS Code extension is installed and enabled in your VS Code IDE. For information about enabling the VS Code extension, see xref:assembly-dmn-models.html[_Installing the {PRODUCT} VS Code extension bundle_].
