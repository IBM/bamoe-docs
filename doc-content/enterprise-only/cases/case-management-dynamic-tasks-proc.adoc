...
+
//For instructions on how to configure the *Apps launcher* button in {CENTRAL}, see //{URL_DEVELOPING_PROCESS_SERVICES}/assembly-showcase-application.html[_{SHOWCASE_APPLICATION_CASE_MANAGEMENT}_].
//ifeval::["{context}" == "getting-started-case-management"]
