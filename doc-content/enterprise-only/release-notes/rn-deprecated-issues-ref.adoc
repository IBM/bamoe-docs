...
Support for Red Hat Fuse 7.13 is deprecated in {PRODUCT} 8.0.9 release. {PRODUCT_SHORT} will receive only extended life cycle support, will not receive any new enhancements or features, and will be removed in a future release.
...
For more information, see xref:assemblies/assembly-pmml-models.html[_{PMML_MODELS}_].
