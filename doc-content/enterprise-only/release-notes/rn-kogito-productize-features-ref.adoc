...
You can now migrate your existing {CENTRAL} projects developed using DMN, PMML, or DRL to {KOGITO} microservices projects. For more information, see xref:assembly-getting-started-migration-to-kogito-microservices.html[_{MIGRATION_KOGITO_SERVICES}_].

== Support for Spring Boot starters

You can now add Spring Boot starters to your {KOGITO} project to get started with {KOGITO} quickly. For more information, see xref:assembly-springboot-business-apps.html[_{GETTING_STARTED_KOGITO_MICROSERVICES}_].
