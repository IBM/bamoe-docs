...
NOTE: {PRODUCT_SHORT} {PRODUCT_VERSION} supports AMQ Streams only for the process events monitoring functionality. For more information, see xref:assemblies/assembly-integrating-amq-streams.html[Integrating {PRODUCT} with {KAFKA_PRODUCT}].
