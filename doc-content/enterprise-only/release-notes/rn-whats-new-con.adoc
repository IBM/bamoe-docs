...
You can now override the Spring Boot and Spring Framework versions with improved flexibility to address security vulnerabilities and apply CVE patches. xref:../doc-content/enterprise-only/springboot/managing-override-dependency-proc.html[Learn more…​]


xref:{enterprise-dir}/springboot/managing-override-dependency-proc.adoc[Learn more…​]

xref:managing-override-dependency-proc.html[Learn more…​]

xref:../springboot/managing-override-dependency-proc.html[Learn more…​]
