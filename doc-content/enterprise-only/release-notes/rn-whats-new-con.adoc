...
The base image has been moved to UBI 9, which is based on Red Hat Enterprise Linux 9. As part of this update, the container images and operator have been renamed to the following:
