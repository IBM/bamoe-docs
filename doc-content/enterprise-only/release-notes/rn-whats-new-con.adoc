...
== Ability to manage and override dependency versions for Spring Boot applications

You can now manage and override Spring Boot and Spring Framework dependency versions with improved flexibility to address security vulnerabilities and apply CVE patches. xref:{enterprise-dir}/springboot/managing-override-dependency-proc.html[Learn more…​]
