...
The base image is now built on UBI 9, which is based on Red Hat Enterprise Linux 9. As part of this update, the container image names and the operator name have been renamed.
