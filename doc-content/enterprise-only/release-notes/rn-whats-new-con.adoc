...
You can now override the Spring Boot and Spring Framework versions with improved flexibility to address security vulnerabilities and apply CVE patches. xref:../springboot/managing-override-dependency-proc.html[Learn more…​]
