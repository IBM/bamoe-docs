...
== Updated base image and renamed images and operator

The base image is moved to UBI 9, which is based on Red Hat Enterprise Linux 9. As part of this update, the container images and operator are renamed to the following:

* ibm-bamoe/bamoe-smartrouter-rhel9
* ibm-bamoe/bamoe-process-migration-rhel9
* ibm-bamoe/bamoe-kieserver-rhel9
* ibm-bamoe/bamoe-dashbuilder-rhel9
* ibm-bamoe/bamoe-controller-rhel9
* ibm-bamoe/bamoe-businesscentral-rhel9
* ibm-bamoe/bamoe-businesscentral-monitoring-rhel9
* ibm-bamoe/bamoe-rhel9-operator

== Ability to overriding Spring Boot and Spring Framework versions

You can now override the Spring Boot and Spring Framework versions with improved flexibility to address security vulnerabilities and apply CVE patches. xref:../doc-content/enterprise-only/springboot/managing-override-dependency-proc.adoc[Learn more…​]


xref:{enterprise-dir}/springboot/managing-override-dependency-proc.adoc[Learn more…​]

xref:managing-override-dependency-proc.adoc[Learn more…​]

xref:../springboot/managing-override-dependency-proc.adoc[Learn more…​]

xref:springboot/managing-override-dependency-proc.adoc[Learn more…​]


xref:assemblies/assembly-pmml-models.html[_{PMML_MODELS}_].

xref:doc-content/enterprise-only/springboot/managing-override-dependency-proc.adoc[Learn more…​]

xref:doc-content/enterprise-only/springboot/managing-override-dependency-proc.html[Learn more…​]
