...
ifdef::DM,PAM[]
You can migrate a PMML service to a {KOGITO} microservice. For more information about migrating to {KOGITO} microservices, see xref:assembly-migration-to-kogito-microservices.html[_{MIGRATION_KOGITO_SERVICES}_].
endif::[]
