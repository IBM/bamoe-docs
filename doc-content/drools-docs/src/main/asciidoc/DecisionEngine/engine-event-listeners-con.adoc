...
For the definitions of event classes, see the https://github.com/kiegroup/drools/tree/main/drools-core/src/main/java/org/drools/core/event[GitHub repository].
