...
During Maven’s test phase, all Test Scenarios defined in `.scesim` files are executed as a single unit test, and the results are saved in the `target/surefire-reports` folder. 
