...
There is an Apache Maven plugin (`org.kie:kie-maven-plugin`) which is recommended to use to get build time validation.
...
To run decision in embedded java mode, you need to use `org.kie:kie-maven-plugin` in your project. Additionally, you need to add KIE specific dependencies.
...
Update your POM file in the following way:
