...
== Complete example
Most of the mentioned concepts can be seen as https://github.com/bamoe/bamoe-docs-source-code-examples/tree/{VERSION_X}/rules-embedded-mode-example[rules-embedded-mode-example].
