...
[NOTE]
====
See xref:authoring-decisions.adoc#adding-a-data-type[adding a data type] to learn more about Complex data types.
====
...
There is source code available for the https://raw.githubusercontent.com/IBM/bamoe-docs/refs/heads/9.2.x/_code/docs/dmn/payroll.dmn[payroll.dmn] example model.
