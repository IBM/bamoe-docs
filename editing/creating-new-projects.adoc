...
There are a lot of elements on this page, and we'll cover all of them here, but let's simplify things a little and talk about what controls are common to Decisions and Workflows first.
