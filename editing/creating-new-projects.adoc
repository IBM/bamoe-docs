...
* {DEV_TOOLS_VSCODE_MARKETPLACE_LINK}[*{DEV_TOOLS}*]: Enables you to view and design BPMN and DMN models in Visual Studio Code (VS Code). See the xref:../tools/developer-tools-for-vscode.adoc[VS Code extension] chapter for further details.
