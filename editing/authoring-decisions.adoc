...
* Only one decision service that shares a common decision can be expanded at a time. To expand a different one, collapse the currently expanded service that includes the same decision.
