...
. Open the DMN editor and select *Documentation* from the *Share* dropdown in the toolbar. This action launches a dialog interface that lists all DMN models in the current project.
