...
. open the DMN editor and select Documentation from the Share dropdown in the toolbar. This action launches a modal interface that lists all DMN models in the current project.
