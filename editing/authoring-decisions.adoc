...
==== version 1.6
DMN 1.6 key features enhance the decision modeling experience, improve consistency, and reduce ambiguity. New features and enhancements in DMN 1.6 are as follows:
