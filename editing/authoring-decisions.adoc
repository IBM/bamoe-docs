...
IBM BAMOE allows you to create a unified HTML or PDF document containing multiple DMN models from Canvas. This enhancement improves usability for projects with complex decision models composed of several DMN files. 
