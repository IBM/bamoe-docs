...
+
This action launches a dialog that lists all DMN models in the current project.
+
...
+
You can print the document or save it as a PDF using the print functionality. The generated document will include DMN diagrams, boxed expressions, and data types, compiled from the files you select. Each selected file contributes its content to the final documentation.
