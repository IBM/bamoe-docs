...
== Generate documentation for multiple DMN models in BAMOE
...
To generate unified documentation, open the DMN editor and select Documentation from the Share dropdown in the toolbar. This action launches a modal interface that lists all DMN models in the current project.

.Share dropdown
image::editing/share-dropdown-documentation.png[width=720px]
...
image::editing/generate-documentation.png[width=720px]
...
To export the document, use the Print button located at the top-left corner of the preview page. This button invokes the browser’s native window.print() functionality, enabling you to print the document or save it as a PDF.

.Print screen
image::editing/print-button.png[width=720px]
