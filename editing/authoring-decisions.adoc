...
NOTE: This version of DMN Editor is compatible with DMN versions 1.5 and 1.6. You can switch to the DMN Editor (classic) but be aware that it will be removed in the future versions and any files created or modified in DMN Editor will not be compatible with the DMN Editor (classic), due to the different DMN versions supported.
