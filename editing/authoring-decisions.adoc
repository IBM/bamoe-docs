...
The Classic DMN Editor supported a subset of 1.3 features, such as the temporal FEEL Functions.
...
It is built based on the same Table component {CANVAS} uses on DMN Runner and so you feel at home in both places.
