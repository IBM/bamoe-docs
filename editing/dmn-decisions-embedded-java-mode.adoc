...
In your client application, add the `org.kie:kie-dmn-core` dependency to the relevant classpath of your Java project. `org.kie:kie-dmn-core` dependency is required for running DMN models in embedded Java mode. For more information, see xref:../reference-guide/maven-repository-libraries.adoc#_decisions_rules_and_decision_tables_embedded_java_mode[Decisions, Rules, and Decision Tables (Embedded Java mode)].
