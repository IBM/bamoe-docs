...
There is available source code of the https://raw.githubusercontent.com/bamoe/bamoe-docs-source-code-examples/{VERSION_X}/dmn/flight-has-capacity.dmn[Filter expression of rebooked flights using item keyword] example model.
