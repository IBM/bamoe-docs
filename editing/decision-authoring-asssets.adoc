...
[NOTE]
====
Please notice {PRODUCT} doesn't contain a PMML modeler. You need to create the PMML model before it is included into DMN model using some other PMML modeler. For example the KIE community https://marketplace.visualstudio.com/items?itemName=kie-group.pmml-vscode-extension[PMML Scorecard Modeler].
====
