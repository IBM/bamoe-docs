...
[NOTE]
====
Please notice {PRODUCT} doesn't contain a PMML Editor. You need to create the PMML model before it is included into DMN model using some other PMML Editor. For example the Apache KIE community https://marketplace.visualstudio.com/items?itemName=kie-group.pmml-vscode-extension[PMML Scorecard Editor].
====
