...
* Can be included with a standalone _Business Service_ project or imported into a project in {CANVAS}
...
.Prerequisites
* You have `org.kie.kogito:drools-decisiontables` added to the `pom.xml` file of your _Business Service_ project to enable decision tables for decision services:
