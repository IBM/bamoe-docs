...
In order for a Decision Table to be compiled in your {PRODUCT} project, the table must comply with certain structure and syntax requirements within an spreadsheet, as shown in this example.
...
. In your VS Code IDE, import the spreadsheet file in the relevant folder of your {PRODUCT} project, typically in `src/main/resources`.
