...
To run this scenario, you must have set up {MVN_REPO} and {DEV_TOOLS}. See xref:../installation/installation.adoc[Installing]. Optionally, you can use Language Support for Java(TM) by Red Hat.
...
NOTE: The following feature is available in the Test Scenario Editor (classic) only. In the new Test Scenario Editor, you need to use a DMN FEEL expression to define a List value
