...
NOTE: All the DMN-based scesim assets created prior to version {VERSION_91x} will require a user action to update the related DMN file location. This is requested because the DMN file path is now managed in a relative format.
