...
To start building your _Business Services_ with {PRODUCT_LONG}, refer to xref:../getting-started/project-setup.adoc[Getting started → Business Service project setup].
