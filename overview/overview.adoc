...
In the next section you will find more detail on the different components and their integration in your Dev and Runtime environments, see xref:key-components.adoc[{PRODUCT_SHORT} Components in the Software Development Lifecycle].
