...
** xref:integrating-ai/custom-generative-ai-task.html[Integrating a custom generative AI task in BPMN]
** xref:integrating-ai/ai-agents-bamoe.html[Technology Preview: Expose BAMOE capabilities to AI agents]
