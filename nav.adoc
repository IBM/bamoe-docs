...
** xref:getting-started/project-setup.html[Initial _Business Service_ project setup and walkthrough]
...
** xref:getting-started/deploying-to-openshift.html[Deploying your first _Business Service_ to OpenShift using Quarkus]
...
//**
* xref:runtime-services-modeling/runtime-services-modeling.html[Building, deploying, and monitoring _Business Services_]
