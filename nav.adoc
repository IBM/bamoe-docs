...
*** xref:upgrade/introduction.html[Introduction]
*** xref:upgrade/key-differences.html[Key differences]
*** xref:upgrade/how-to-navigate.html[Navigating this document]
*** xref:upgrade/dev-environment-comparison.html[Development environment comparison]
*** xref:upgrade/prod-environment-comparison.html[Production environment comparison]
*** xref:upgrade/upgrading-projects.html[Upgrading projects]
**** xref:upgrade/client-server-projects.html[Upgrading client server projects]
**** xref:upgrade/standalone-projects.html[Upgrading standalone projects]
**** xref:upgrade/individual-assets.html[Upgrading individual assets]
**** xref:upgrade/custom-workitem-handlers.html[Upgrading custom WorkItemHandlers]
**** xref:upgrade/usergroups-callback.html[Upgrading UserGroupsCallback]
**** xref:upgrade/business-calendar.html[Upgrading business calendar]
**** xref:upgrade/authentication-authorization.html[Upgrading authentication or authorization]
**** xref:upgrade/event-streaming.html[Upgrading event streaming]
*** xref:upgrade/live-data-considerations.html[Live data considerations]
*** xref:upgrade/operation-considerations.html[Operation considerations]
*** xref:upgrade/performance-considerations.html[Performance considerations]
*** xref:upgrade/miscellaneous.html[Miscellaneous]
**** xref:upgrade/work-item-handlers.html[Migrating WorkItemHandlers]
**** xref:upgrade/business-central-sample-projects.html[Business central's sample project]
**** xref:upgrade/create-migrate-workitem-handlers.html[Creating custom WorkItemHandlers]
*** xref:upgrade/up-known-limitations.html[Known limitations]
*** xref:upgrade/not-supported.html[Not supported in BAMOE 9.x]
*** xref:upgrade/sample-project-references.html[Sample project references]
