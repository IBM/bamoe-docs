...
*** xref:upgrade/05-production-environment-comparison.html[Production environment comparison]
*** xref:upgrade/06-00-upgrading-projects.html[Upgrading projects]
**** xref:upgrade/06-01-upgrading-structure-differences.html[Structure differences]
**** xref:upgrade/06-02-upgrading-client-server-projects.html[Upgrading client server projects]
**** xref:upgrade/06-03-upgrading-standalone-projects.html[Upgrading standalone projects]
**** xref:upgrade/06-04-upgrading-individual-assets.html[Upgrading individual assets]
**** xref:upgrade/06-05-upgrading-custom-work-item-handlers.html[Upgrading custom WorkItemHandlers]
**** xref:upgrade/06-06-upgrading-user-groups-callback.html[Upgrading UserGroupsCallback and AssignmentStrategy]
**** xref:upgrade/06-07-upgrading-business-calendar.html[Upgrading business calendar]
**** xref:upgrade/06-08-upgrading-authentication-authorization.html[Upgrading authentication/authorization]
**** xref:upgrade/06-09-upgrading-event-streaming.html[Upgrading event streaming]
**** xref:upgrade/06-10-upgrading-case-management-project.html[Upgrading case management project]
*** xref:upgrade/07-upgrading-live-data-considerations.html[Live data considerations]
...
*** xref:tools/working-with-gitlab.html[Working with GitLab]
*** xref:tools/working-with-bitbucket.html[Working with Bitbucket Data Center]
...
** xref:workflow/authoring-workflows-techpreview.html[Technology preview - Authoring Workflows with new BPMN editor]
