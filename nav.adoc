...
// ** xref:workflow/running-workflows-with-dev-ui.html[Running Workflows locally with BAMOE Quarkus Dev UI]** xref:workflow/process-api.html[Process API]
...
** xref:integrating-ai/ai-agents-bamoe.html[Expose BAMOE capabilities to AI agents]
