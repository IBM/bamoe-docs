...
You can access the docker-compose file from the https://www.ibm.com/support/pages/node/7001673[Support and Download Page].
...
//These steps could be more specific regarding where to find the compose.zip file
