...
The `bamoe-9.1.0-docker-compose.zip` can only be downloaded from IBM Passport Advantage, and you can find information on the https://www.ibm.com/support/pages/node/7151078[Support and Download Page].

== Run

To Run {CANVAS} with Docker Compose follow these steps:

. Extract the downloaded `bamoe-9.1.0-docker-compose.zip`.
