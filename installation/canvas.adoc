...
All the three image versions must be the same for a deployment to work.
...
The `bamoe-{VERSION}-canvas-docker-compose.zip` can only be downloaded from IBM Passport Advantage, and you can find information on the https://www.ibm.com/support/pages/node/7266365[BAMOE 9.4 Download Document].
...
== Configuring GitHub, GitHub Enterprise Server, GitLab, or BitBucket Data Center
