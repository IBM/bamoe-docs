...
[
   {
    ...
    "gitRepositoryGitRef": "9.3.0-ibm-0001-quarkus-full",
    ...
    
  {
    ...
    "gitRepositoryUrl": "https://github.com/ibm/bamoe-canvas-quarkus-accelerator",
    "gitRepositoryGitRef": "9.3.0-ibm-0001-quarkus-dmn",
    "dmnDestinationFolder": "src/main/resources",
    "bpmnDestinationFolder": "src/main/resources",
    "otherFilesDestinationFolder": "src/main/resources"
  },

  {
    ...
    "gitRepositoryUrl": "https://github.com/ibm/bamoe-canvas-quarkus-accelerator",
    "gitRepositoryGitRef": "9.3.0-ibm-0001-spring-boot-full",
    "dmnDestinationFolder": "src/main/resources",
    "bpmnDestinationFolder": "src/main/resources",
    "otherFilesDestinationFolder": "src/main/resources"
  },
...
To allow users to connect to your organization's source code control instance, you will need to configure the `KIE_SANDBOX_AUTH_PROVIDERS` environment variable on your {CANVAS} installation. For more information refer to the https://quay.io/repository/bamoe/canvas?tab=info[{CANVAS} image description on Quay.io]. 

Once you have done this {CANVAS} users have access to the functionality available in the different integrations:

* xref:../tools/working-with-git.adoc[Canvas -> Working with Git]
