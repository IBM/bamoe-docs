...
[
   {
    ...
    "gitRepositoryGitRef": "{QUARKUS_VERSION_930}-quarkus-full",
    ...
    
  {
    ...
    "gitRepositoryUrl": "https://github.com/ibm/bamoe-canvas-quarkus-accelerator",
    "gitRepositoryGitRef": "{QUARKUS_VERSION_930}-quarkus-dmn",
    "dmnDestinationFolder": "src/main/resources",
    "bpmnDestinationFolder": "src/main/resources",
    "otherFilesDestinationFolder": "src/main/resources"
  },

  {
    ...
    "gitRepositoryUrl": "https://github.com/ibm/bamoe-canvas-quarkus-accelerator",
    "gitRepositoryGitRef": "{SPRING_VERSION_930}-spring-boot-full",
    "dmnDestinationFolder": "src/main/resources",
    "bpmnDestinationFolder": "src/main/resources",
    "otherFilesDestinationFolder": "src/main/resources"
  },
...
After completing these configurations, {CANVAS} users can access the features provided by each integration. For additional information, see xref:../tools/connecting-accounts.adoc[Connecting to Git and Cloud providers].
