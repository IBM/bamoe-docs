...
The default Quarkus and Spring Boot accelerators, available in {CANVAS} and {DEV_TOOLS}, can be found in the xref:https://github.com/IBM/bamoe-canvas-quarkus-accelerator[repository: {BOM_VERSION} branch]. Use these default projects to understand what you want to change in your custom acclerator. 
