...
NOTE: You can add environment variable configuration to your docker-compose.yml file or pass it directly via a docker run command. For more information, see https://quay.io/repository/bamoe/canvas.
