...
To configure GitLab, add the following JSON object to the authentication provider array:
...
To configure Bitbucket Data Center, add the following JSON object to the authentication provider array:
