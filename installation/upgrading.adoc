...
* Update pom files from your projects with {Version_910} {PRODUCT_SHORT} BOM
...
Existing DMN files (any version) can be opened directly in the editor. However if you edit and save your file it will be migrated automatically to DMN 1.5 and cannot subsequently be opened by the legacy editor. If you wish to continue with your current DMN version and the legacy editor, you can select the DMN Editor dropdown to toggle between the legacy and new editor. For more information, see xref:../../tools/authoring-decisions.adoc