...
The BAMOE Management Console will be up at http://localhost:8080

=== Setting environment varialbes

You can set the environment variables for the BAMOE Management Console image via Docker's environment variables.
