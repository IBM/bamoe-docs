= Tracking the BAMOE License use in IBM
...
See the section, https://www.ibm.com/support/pages/downloading-ibm-license-metric-tool-92[License Metric Tool with disconnected scanners to install on Linux or Windows] in page, for guideline on obtaining and installing ILMT.

== Using and Configuring BAMOE ILMT Libraries

License Metric Tool automatically detects the following {PRODUCT_LONG} {VERSION_91X} release chargeable components that are part of the product:
