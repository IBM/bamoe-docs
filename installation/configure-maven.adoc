...
If you prefer not to use containers, you can download and configure the {PRODUCT_SHORT} Maven repository from the compressed file. The {PRODUCT_SHORT} Maven repository contains the libraries that Java developers need to build {PRODUCT_SHORT} applications.
