...
The Maven libraries required to develop _Business Services_ with {PRODUCT_SHORT} are shipped in the Maven repository format as a `.zip` file or via HTTP through a Container image you can deploy to your infrastructure.
