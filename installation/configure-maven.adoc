...
This is important because we'll need to run a container on port 80, which usually OpenShift blocks with the default Service Account:
...
NOTE: If you can't create a Service Account with elevated privileges, xref:../introduction/release-notes/build-maven-repo.adoc[learn how to build your own bamoe-maven-repository image using a different port].
