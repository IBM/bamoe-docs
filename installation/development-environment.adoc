...
[source,shell,subs="attributes+"]
----
docker pull --arch amd64 quay.io/bamoe/canvas:{IMAGE_VERSION}
docker pull --arch amd64 quay.io/bamoe/cors-proxy:{IMAGE_VERSION}
docker pull --arch amd64 quay.io/bamoe/extended-services:{IMAGE_VERSION}
----
+
...
[source,shell,subs="attributes+"]
----
docker tag quay.io/bamoe/canvas:{IMAGE_VERSION} $REGISTRY/$NAMESPACE/canvas:{IMAGE_VERSION}
docker tag quay.io/bamoe/cors-proxy:{IMAGE_VERSION} $REGISTRY/$NAMESPACE/cors-proxy:{IMAGE_VERSION}
docker tag quay.io/bamoe/extended-services:{IMAGE_VERSION} $REGISTRY/$NAMESPACE/extended-services:{IMAGE_VERSION}
----
+
...
[source,shell,subs="attributes+"]
----
docker push $REGISTRY/$NAMESPACE/canvas:{IMAGE_VERSION} --tls-verify=false
docker push $REGISTRY/$NAMESPACE/extended-services:{IMAGE_VERSION} --tls-verify=false
docker push $REGISTRY/$NAMESPACE/cors-proxy:{IMAGE_VERSION} --tls-verify=false
----
+
