...
Where you replace `dmoe-dev-environment-helm-chart` with `pamoe-dev-environment-helm-chart` if you are working with {PRODUCT_PAM}, and `YOUR_OCP_DOMAIN` defines the route to your OpenShift domain.
