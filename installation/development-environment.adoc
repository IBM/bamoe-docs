...
* Access to an OpenShift cluster with the `oc` CLI tool installed and configured
* Podman installed on your local machine
* Access to pull images from `quay.io/bamoe`
...
----
+
. Select or create the target project where the {CANVAS} application will be deployed.
+
[source,shell]
----
...
----
+
. Log in to the OpenShift image registry using Podman.
+
[source,shell]
----
...
----
+
. Deploy {EXTENDED_SERVICES} and label its resources.
+
[source,shell,subs="attributes+"]
----
