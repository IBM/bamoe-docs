...
For more information see xref:../tools/connecting-accounts.adoc[Connecting to Git and Cloud providers].
...
After completing the configuration, you can access the features provided by each integration. For more information, 
...
You can use the following default accelerators for _Business Services_ that are available for Quarkus and Spring Boot with Maven.
...
You can use the following default accelerators for _Business Services_ that are available for Quarkus and Spring Boot with Gradle.
...
NOTE: You can override this value to include your own custom accelerators by either replacing the default ones or appending additional entries alongside them.
////
...
== Configuration Reference for BAMOE Dev Environment Helm Chart

The following table lists the configurable parameters of the BAMOE Dev Environment chart and their default values.
...
| global.chargedProductValues.productID | string | "46b14c7f2f894218a7879b3f6416024f" (DMOE) / "72984f114b54496a8a44be139154a988" (PAMOE) | Product ID for ILMT tracking 

| global.chargedProductValues.productMetric | string | "VIRTUAL_PROCESSOR
_CORE" | Product metric for ILMT tracking 

| global.chargedProductValues.productName | string | "IBM Decision Manager Open Edition" (DMOE) / "IBM Process Automation Manager Open Edition" (PAMOE) | Product name for ILMT tracking 
...
| canvas.env | list | [{"name":"KIE_SANDBOX
_EXTENDED_SERVICES
_URL","value":"http://127.0.0.1:21345"},{"name":"KIE_SANDBOX
_CORS_PROXY
_URL","value":"http://127.0.0.1:8081"}] | Env variables for BAMOE Canvas deployment

| canvas.image | object | {"account":"bamoe","name":"canvas","pullPolicy":"IfNotPresent","registry":"quay.io","tag":"main"} | Image source configuration for the BAMOE Canvas image
...
| cors_proxy.image | object | {"account":"bamoe","name":"cors-proxy","pullPolicy":"IfNotPresent","registry":"quay.io","tag":"main"} | Image source configuration for the CORS Proxy image
|===
...
| extended_services.image | object | {"account":"bamoe","name":"extended-services","pullPolicy":"IfNotPresent","registry":"quay.io","tag":"main"} | Image source configuration for the Extended Services image 
|===
...
| maven_repository.enabled | bool | TRUE | Enable or disable Maven Repository installation

| maven_repository.name | string | "maven-repository" | The Maven Repository application name

| maven_repository.image | object | {"account":"bamoe","name":"maven-repository","pullPolicy":"IfNotPresent","registry":"quay.io","tag":"main"} | Image source configuration for the Maven Repository image
|===
