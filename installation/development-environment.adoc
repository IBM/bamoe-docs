...
Where you replace `dmoe-dev-environment-helm-chart` with `pamoe-dev-environment-helm-chart` if you are working with {PRODUCT_PAM}. `YOUR_OCP_DOMAIN` is defined as the route to your OpenShift domain.
