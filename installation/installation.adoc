...
Everything you need to learn how to install {PRODUCT} and setup your project is available at xref:../getting-started/project-setup.adoc[Initial Project Setup and Walkthrough].

In this section you will learn how to install other tools that are part of {PRODUCT} and that can help you during the authoring of Decisions and Workflows, namely {CANVAS} and {VS_CODE_BUNDLE}.
