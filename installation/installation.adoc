...
Everything you need to learn about installing {PRODUCT} and setting up your project is available at xref:../getting-started/project-setup.adoc[Initial Project Setup and Walkthrough].
