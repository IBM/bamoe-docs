...
To start a new _Business Service_ project, follow xref:../getting-started/project-setup.adoc[Getting started → Initial _Business Service_ project setup and walkthrough].
