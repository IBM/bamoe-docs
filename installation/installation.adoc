...
** xref:configure-maven.adoc[BAMOE Maven repository]
** xref:canvas.adoc[BAMOE Canvas]
** xref:developer-tools-for-vscode.adoc[BAMOE Developer Tools for VS Code]
** xref:canvas.adoc[BAMOE Management Console]
** xref:ilmt-overview.adoc[Licenses and tracking usage]

To setup a project for a Business Service application, follow xref:../getting-started/project-setup.adoc[Initial Project Setup and Walkthrough].
