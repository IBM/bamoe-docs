...
* {PRODUCT_SHORT} components and _Business Services_ you build must include the license tracking annotations, see xref:ilmt-track-bamlcns-metrictool.adoc[Tracking license use in ILMT] or xref:ilmt-track-bamlcns-kubernetes.adoc[Tracking license use in ILMT], depending on your development environment.
