...
* All _Business Services_ built using {PRODUCT_SHORT} must include the license tracking annotations (for an example see xref:../getting-started/deploying-to-openshift.adoc[Gettting Started → Deploying to OpenShift]) 
