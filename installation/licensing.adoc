...
** {PRODUCT_DM} includes the functionality to be able to develop and orchestrate decision and rules based _Business Services_.
** {PRODUCT_PAM} includes all functionality in {PRODUCT_DM} and additional functionality to be able to develop stateful workflow _Business Services_. For example, Management console is only available in this product. 
