...
* {PRODUCT_SHORT} components and _Business Services_ you build must include the license tracking annotations, see xref:ilmt-track-bamlcns-metrictool.adoc[Tracking license use in ILMT] or xref:ilmt-track-bamlcns-kubernetes.adoc[Tracking license use in Kubernetes], depending on your development environment.
...
Installation of the Dev and Runtime environment Helm charts enables the licensing information to be set up automatically in the Cloud environment. 
