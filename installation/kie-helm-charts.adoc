...
{CANVAS} helm chart is a Helm chart based on the open-source KIE Sandbox and it is a technology that can enable you to install multi-container services with a single command: Helm, https://helm.sh/[the package manager for Kubernetes].
