...
In this section you will find all the information needed to implement the supported customization scenarios for the {PRODUCT_SHORT} container images. The following lists the main reasons to customize container images: 
...
Customization is made possible by overriding the base operating system images. This enables you to maintain the functionality and compatibility with {PRODUCT_SHORT} releases. 

[#introducing-container-images]
== Introducing {PRODUCT_SHORT} container images

You can customize any of the containers delivered in the {PRODUCT_SHORT} distribution. The following table lists the container images that can be customized, along with their descriptions, whether they are delivered through helm chart, and type.
