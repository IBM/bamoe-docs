...
* Alternative
+
If you have installed {CANVAS} by using `yaml` resources, the deployment resource must be edited to add the following lines in case of IBM Decision Manager Open Edition:
+
[source,yaml]
----
spec:
...
And add the following lines in case of IBM Process Automation Manager Open Edition:
