...
For more information about BPMN, see the https://www.omg.org/spec/BPMN/2.0/About-BPMN[Object Management Group (OMG) Business Process Model and Notation (BPMN) 2.0 specification].
