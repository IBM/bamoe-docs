...
== The Jobs subsystem
The Jobs service takes care of scheduling jobs, in particular timers such as those from boundary events, SLA, or throw events relevant to timers. It is also used for human tasks notifications. 
