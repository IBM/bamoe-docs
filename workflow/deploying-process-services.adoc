= Developing and deploying a stateful workflow service
...
The Jobs subsystem only supports Quarkus runtimes and storage can be PostgreSQL or Microsoft SQL Server.
