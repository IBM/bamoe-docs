...
== BAMOE REST WorkItemHandler examples

BAMOE provides examples to demonstrate BAMOE REST WorkItemHandler capabilities. These examples are part of the official BAMOE Examples repository and are included in the BAMOE distribution zip file under `/examples` directory. For more information, see the https://github.ibm.com/dba/bamoe-examples[BAMOE Examples repository].

The https://github.ibm.com/dba/bamoe-examples/tree/main/process-rest-workitem-quarkus[process-rest-workitem-quarkus] is an already existing example enhanced with new capabilities. The example demonstrates BAMOE REST WorkItemHandler used with Quarkus. The example includes the following elements:
...
The https://github.ibm.com/dba/bamoe-examples/tree/main/process-rest-workitem-springboot[process-rest-workitem-springboot] is a new example for BAMOE 9.x. The example demonstrates the BAMOE REST WorkItemHandler in Spring Boot runtime. The example includes the following elements:
...
== BAMOE REST WorkItemHandler use cases
...
== BAMOE REST WorkItemHandler error handling

BAMOE REST WorkItemHandler provides error handling across multiple failure scenarios. See the following table for reference.
