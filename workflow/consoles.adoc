= Interacting with processes and tasks the Management Console
include::../partials/attributes.adoc[]

== Management console

The Management console is a web application for viewing the state of all available {PRODUCT_SHORT} services and manage and interact with process instances:

.Management Console
image::runtime-services-modeling/kogito-management-console.png[Image of Kogito Management Console]

You can use the Management console to manage and interact with process instances, submit task forms, and view jobs. These are the different elements you can view:
...
In order to be visible in the Management console your {PRODUCT_SHORT} services must use the following {PRODUCT_SHORT} components:

* *{PRODUCT_SHORT} Data index service*: Enables the Management console to access stored events related to processes and domain data from your {PRODUCT_SHORT} services. The data index service requires PostgreSQL persistence.
