...
* xref:../workflow/overview.html[Overview stateful Workflows with Compact Architecture] - describes the components of stateful workflow service in Compact Architecture.
* xref:../workflow/authoring-workflow.html[Authoring stateful Workflows] - describes aspects to be taken into account when authoring your stateful process in BPMN.
* xref:../workflow/running-workflows.html[Running Workflows locally with {DEV_TOOLS}] - explains how run a workflow application in VS Code
