...
* xref:../workflow/running-workflows-with-dev-ui.html[Running Workflows locally with {QUARKUS_DEV_UI}] - explains how to run a workflow application using {QUARKUS_DEV_UI}.
