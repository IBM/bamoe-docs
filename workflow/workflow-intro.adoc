...
* xref:../workflow/authoring-workflows.html[Authoring stateful Workflows] - describes aspects to be taken into account when authoring your stateful process in BPMN.
...
* xref:../workflow/workflows-with-quarkus.html[Workflow services with Quarkus] - describes how to set up a workspace service with Quarkus.
