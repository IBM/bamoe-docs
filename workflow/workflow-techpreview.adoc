...
* xref:../tools/form-generation-tool.html[Form Generation tool] - describes how to use the Form generation tool to generate the web forms needed for process execution.
...
* xref:runtime-services-modeling/consoles.html[Interacting with processes and tasks using Consoles] - describes how the {PRODUCT_SHORT} Management Console can be used to view and manage available BAMOE services. 