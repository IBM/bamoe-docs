...
You do not need to add the library to your project. It is already included in all BAMOE Workflow Accelerators. The library is automatically configured and available for use in your workflows by https://github.com/apache/incubator-kie-kogito-runtimes/tree/main/addons/common/rest[`org.kie.kogito:kogito-rest-workitem`] dependency included in BAMOE BOM. You can access the handler through BPMN Editor task palette without adding any additional dependencies.
