...
After reading xref:../workflow/workflows-with-quarkus.html[Workflows services with Quarkus] and getting your project ready, it's time to add the {QUARKUS_DEV_UI} to your project.
...
Not directly related to the {QUARKUS_DEV_UI}, but also a useful tool to explore the APIs of your Workflow.
