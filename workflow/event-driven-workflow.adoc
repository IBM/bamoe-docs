= Events and the Process Engine
include::../partials/attributes.adoc[]
include::../styles/images.adoc[]

The Process Engine executes business processes. To define the processes, you create business assets, including process definitions and custom tasks. The combination of events and business processes is a way to unlock powerful capabilities in automation solutions developed in {PRODUCT_SHORT}. 
...
You can implement any of these methods to process the corresponding event. You can use the methods of the event class to retrieve other classes that contain all information about the entities involved in the event.
