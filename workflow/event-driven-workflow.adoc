...
+
If the listener modifies a resource outside the scope of the listener method, ensure the resource is enlisted in the current transaction. If the transaction rolls back, un-enlisted resources will become inconsistent.
