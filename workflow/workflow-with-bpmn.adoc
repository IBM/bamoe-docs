...
This section lists the newly supported BPMN elements in the tech preview showing examples of how to use them in the two possible BPMN editors: Canvas and VS Code. 
