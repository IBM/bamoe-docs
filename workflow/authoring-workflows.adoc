...
.Empty Workflow on BPMN Editor
image::workflow/new-bpmn-editor.png[BPMN Editor (Technology Preview)]

== Authoring Workflows with BPMN Editor
...
Developing Workflows thrDecough BPMN files is a complex subject and has many intricacies that are beyond the scope of this document.
