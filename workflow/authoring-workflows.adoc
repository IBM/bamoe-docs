...
Since version {VERSION_921}, {PRODUCT_SHORT} includes a new BPMN Editor as Technology Preview, bringing faster startup times and backward compatibility with BPMN Editor (classic). The new BPMN Editor (Technology Preview) is avaialble on {CANVAS}, {DEV_TOOLS}, and as a standalone JavaScript library.
