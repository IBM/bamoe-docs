...
This section lists the supported Business Process Model And Notation (BPMN) elements and describes how to use them in the BPMN Editor in both {CANVAS} and {DEV_TOOLS}. 
