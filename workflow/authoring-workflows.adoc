...
An example application `flexible-process-quarkus` can be found in xref:../getting-started/examples.adoc[Example Business Service projects]. This example shows the use of flexible processes to implement a case management scneario using ad-hoc subprocesses, milestones, and DMN business rule integration. 
