...
+
.New Workflow project with Accelerator
...
. Download the project to your local development environment by clicking on *Share* → *All files*. This enables you to run the project locally with {DEV_TOOLS}. 
