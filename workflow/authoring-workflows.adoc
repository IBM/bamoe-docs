...
. The same directory as the BPMN file (e.g., `[myProject]/src/main/resources/bpmn/tasks.wid`), which could be in a Java package structure (e.g., `src/main/resources/com/ibm/`).
