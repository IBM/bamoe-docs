...
You can choose between the three options for the User Task lifecycle inside your process:
...
* A custom lifecycle, see xref:xxxxx
 
You can override the default lifecycle using the following property to select the User Task Lifecycle implementation you require:
...
=== The Default User Task life cycle
...
.The Human Task life cycle
image::workflow/ws-humantask-lifecycle.png[]

NOTE: The Human Task adheres to the WS-HumanTask standard with the exception of the `suspendUntil` event. 
