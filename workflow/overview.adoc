...
The User Task subsystem defines a Default life cycle that enables users to transition a task through different phases that will change
...
With the Default life cycle, when a User Task is initiated in the User Task Subsystem it starts in a *Created* state. At that moment,
