...
If a custom User Task lifecycle implementation is provided in your _Business Service_, it takes precedence over the property and will be automatically selected as the default User Task lifecycle irrespective of the property.
...
NOTE: The Human Task lifecycle adheres to the WS-HumanTask standard with the exception of the `suspendUntil` event which is not supported. 
