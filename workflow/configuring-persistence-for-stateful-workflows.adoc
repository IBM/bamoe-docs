...
NOTE: If your _Business Service_ uses Microsoft SQL Server persistence in Quarkus Dev Mode and want to use the Database Dev Services,
...
Additionally, if the _Business Service_ includes the Data-Index or Jobs Service, it's also required to add the `bamoe-mssql-mappings` dependency
