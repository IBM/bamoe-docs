...
The xref:../workflow/user-tasks.adoc[User Task API] layer integrates an  Authentication layer.  All the endpoints in the User Task API layer require, as QueryParameters, the groups and the user associated with a User Task under management.
