...
This section provides more detail on the deployment of a _Business Service_ containing stateful worklow(s) and interactions with the production database. 
