...
{PRODUCT_SHORT} process service and all the {PRODUCT_SHORT} subsystems (Data-Index, Data Audit, Job Service and User Tasks) use JDBC to persist
...
Additionally, if the {PRODUCT_SHORT} application includes the Data-Index or Job Service, it's also required to add the `bamoe-mssql-mappings` dependency
