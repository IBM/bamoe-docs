...
For information on setting up {CANVAS} see xref:../installation/canvas.adoc[Installing → {CANVAS}]
...
When using the {DEV_TOOLS} extension, developers can seamlesly interact with business assets directly from the developer IDE.
