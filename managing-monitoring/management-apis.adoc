...
In {PRODUCT_SHORT}, Management APIs are provided to interact with business Process Definitions and active Process Instances. These APIs enable you to obtain metadata information about Process Definitions, as well as provide management endpoints for active Process Instances.
[#management-api]
...
image::runtime-services-modeling/pim-swagger.png[Swagger UI showing {PRODUCT_SHORT} PIM Add-on, 300]
